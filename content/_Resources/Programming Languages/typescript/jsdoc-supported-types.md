...
most basic like `string`](2/basic-types) to [the most advanced, like
conditional types](2/conditional-types).
...
in TypeScript. Satisfies is used to declare that a value implements a
type but does not affect the type of the value.
...
/**
 * @param  p1 - A 'rest' arg (array) of strings. (treated as 'any')
 */
function fn10(p1) {}
/**
 * @param  p1 - A 'rest' arg (array) of strings. (treated as 'any')
