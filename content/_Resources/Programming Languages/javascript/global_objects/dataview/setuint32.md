...
The `setUint32()` method of [`DataView`](../dataview) instances takes a
number and stores it as a 32-bit unsigned integer in the 4 bytes
...
--------------
  ...
  [\#
  sec-dataview.prototype.setuint32]](https://tc39.es/ecma262/multipage/structured-data.html#sec-dataview.prototype.setuint32)
