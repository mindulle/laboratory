...
The `setFloat32()` method of [`DataView`](../dataview) instances takes a
number and stores it as a 32-bit floating point number in the 4 bytes
...
--------------
  ...
  [\#
  sec-dataview.prototype.setfloat32]](https://tc39.es/ecma262/multipage/structured-data.html#sec-dataview.prototype.setfloat32)
