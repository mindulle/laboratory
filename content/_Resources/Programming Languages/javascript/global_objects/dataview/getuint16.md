...
The `getUint16()` method of [`DataView`](../dataview) instances reads 2
bytes starting at the specified byte offset of this `DataView` and
interprets them as a 16-bit unsigned integer. There is no alignment
...
--------------
  ...
  [\#
  sec-dataview.prototype.getuint16]](https://tc39.es/ecma262/multipage/structured-data.html#sec-dataview.prototype.getuint16)
