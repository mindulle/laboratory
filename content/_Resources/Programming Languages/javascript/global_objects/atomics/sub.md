...
The `Atomics.sub()` static method subtracts a given value at a given
position in the array and returns the old value at that position. This
atomic operation guarantees that no other write happens until the
...
--------------
  ...
  [\#
  sec-atomics.sub]](https://tc39.es/ecma262/multipage/structured-data.html#sec-atomics.sub)
