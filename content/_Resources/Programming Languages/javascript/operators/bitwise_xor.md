...
and tests the types of them. It performs BigInt XOR if both operands
...
Bitwise XORing any number `x` with `0` returns `x` converted to a 32-bit
...
--------------
  ...
  [\#
  prod-BitwiseXORExpression]](https://tc39.es/ecma262/multipage/ecmascript-language-expressions.html#prod-BitwiseXORExpression)
