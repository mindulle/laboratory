...
:   -   @[Deprecated](deprecated-class)(\"Use UnsupportedError
        instead\")

Constructors
------------

[IntegerDivisionByZeroException](integerdivisionbyzeroexception/integerdivisionbyzeroexception)()
...
[message](integerdivisionbyzeroexception/message) →
[String](string-class)?
...
[toString](integerdivisionbyzeroexception/tostring)() →
[String](string-class)
