...
[AreaElement](areaelement/areaelement)()

::: {.constructor-modifier .features}
factory
:::

[AreaElement.created](areaelement/areaelement.created)()
...
[alt](areaelement/alt) ↔ [String](../dart-core/string-class)
...
[coords](areaelement/coords) ↔ [String](../dart-core/string-class)
...
[download](areaelement/download) ↔ [String](../dart-core/string-class)?
...
[hash](areaelement/hash) ↔ [String](../dart-core/string-class)?
...
[host](areaelement/host) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write, override
:::

[hostname](areaelement/hostname) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write, override
:::

[href](areaelement/href) ↔ [String](../dart-core/string-class)?
...
[origin](areaelement/origin) → [String](../dart-core/string-class)?
...
[password](areaelement/password) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write, override
:::

[pathname](areaelement/pathname) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write, override
:::

[port](areaelement/port) ↔ [String](../dart-core/string-class)?
...
[protocol](areaelement/protocol) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write, override
:::

[referrerPolicy](areaelement/referrerpolicy) ↔
[String](../dart-core/string-class)?
...
[rel](areaelement/rel) ↔ [String](../dart-core/string-class)
...
[search](areaelement/search) ↔ [String](../dart-core/string-class)?
...
[shape](areaelement/shape) ↔ [String](../dart-core/string-class)
...
[target](areaelement/target) ↔ [String](../dart-core/string-class)
...
[username](areaelement/username) ↔ [String](../dart-core/string-class)?
...
[toString](areaelement/tostring)() → [String](../dart-core/string-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/AreaElement-class.html>
:::
