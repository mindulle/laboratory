...
[SelectElement.created](selectelement/selectelement.created)()
...
[autofocus](selectelement/autofocus) ↔ [bool](../dart-core/bool-class)
...
[disabled](selectelement/disabled) ↔ [bool](../dart-core/bool-class)
...
[form](selectelement/form) → [FormElement](formelement-class)?
...
[length](selectelement/length) ↔ [int](../dart-core/int-class)?
...
[multiple](selectelement/multiple) ↔ [bool](../dart-core/bool-class)?

::: {.features}
read / write
:::

[name](selectelement/name) ↔ [String](../dart-core/string-class)?
...
[required](selectelement/required) ↔ [bool](../dart-core/bool-class)?
...
[size](selectelement/size) ↔ [int](../dart-core/int-class)?
...
[type](selectelement/type) → [String](../dart-core/string-class)

::: {.features}
read-only
:::

[validationMessage](selectelement/validationmessage) →
[String](../dart-core/string-class)
...
[validity](selectelement/validity) →
...
[value](selectelement/value) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write
:::

[willValidate](selectelement/willvalidate) →
[bool](../dart-core/bool-class)
...
[add](selectelement/add)([Object](../dart-core/object-class) element,
[Object](../dart-core/object-class)? before) → void
...
[checkValidity](selectelement/checkvalidity)() →
[bool](../dart-core/bool-class)
...
[item](selectelement/item)([int](../dart-core/int-class) index) →
[Element](element-class)?
...
[namedItem](selectelement/nameditem)([String](../dart-core/string-class)
name) → [OptionElement](optionelement-class)?
...
[reportValidity](selectelement/reportvalidity)() →
[bool](../dart-core/bool-class)
...
[setCustomValidity](selectelement/setcustomvalidity)([String](../dart-core/string-class)
error) → void
...
<https://api.dart.dev/stable/2.18.5/dart-html/SelectElement-class.html>
:::
