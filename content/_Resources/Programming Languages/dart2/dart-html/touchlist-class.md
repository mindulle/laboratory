...
:   -   [List](../dart-core/list-class)\<[Touch](touch-class)\>

Mixed in types

:   -   [ListMixin](../dart-collection/listmixin-class)\<[Touch](touch-class)\>
    -   [ImmutableListMixin](immutablelistmixin-class)\<[Touch](touch-class)\>
...
[first](touchlist/first) ↔ [Touch](touch-class)
...
[Iterator](../dart-core/iterator-class)\<[Touch](touch-class)\>
...
[last](touchlist/last) ↔ [Touch](touch-class)
...
[length](touchlist/length) ↔ [int](../dart-core/int-class)
...
[Iterable](../dart-core/iterable-class)\<[Touch](touch-class)\>
...
[single](touchlist/single) → [Touch](touch-class)
...
[add](immutablelistmixin/add)([Touch](touch-class) value) → void
...
[addAll](immutablelistmixin/addall)([Iterable](../dart-core/iterable-class)\<[Touch](touch-class)\>
iterable) → void
...
test([Touch](touch-class) element)) → [bool](../dart-core/bool-class)
...
[elementAt](touchlist/elementat)([int](../dart-core/int-class) index) →
[Touch](touch-class)
...
start, [int](../dart-core/int-class) end, \[[Touch](touch-class)?
fillValue\]) → void
...
test([Touch](touch-class) element), {[Touch](touch-class) orElse()?}) →
[Touch](touch-class)
...
combine(T previousValue, [Touch](touch-class) element)) → T
...
[followedBy](../dart-collection/listmixin/followedby)([Iterable](../dart-core/iterable-class)\<[Touch](touch-class)\>
other) → [Iterable](../dart-core/iterable-class)\<[Touch](touch-class)\>
...
action([Touch](touch-class) element)) → void
...
test([Touch](touch-class) element), \[[int](../dart-core/int-class)
...
[Touch](touch-class) element) → void
...
index, [Iterable](../dart-core/iterable-class)\<[Touch](touch-class)\>
iterable) → void
...
[item](touchlist/item)([int](../dart-core/int-class) index) →
[Touch](touch-class)?
...
[map](../dart-collection/listmixin/map)\<T\>(T f([Touch](touch-class)
...
[reduce](../dart-collection/listmixin/reduce)([Touch](touch-class)
combine([Touch](touch-class) previousValue, [Touch](touch-class)
element)) → [Touch](touch-class)
...
[removeLast](immutablelistmixin/removelast)() → [Touch](touch-class)
...
test([Touch](touch-class) element)) → void
...
count) → [Iterable](../dart-core/iterable-class)\<[Touch](touch-class)\>
...
test([Touch](touch-class) element)) →
[Iterable](../dart-core/iterable-class)\<[Touch](touch-class)\>
...
compare([Touch](touch-class) a, [Touch](touch-class) b)?\]) → void
...
[Set](../dart-core/set-class)\<[Touch](touch-class)\>
...
[operator
+](../dart-collection/listmixin/operator_plus)([List](../dart-core/list-class)\<[Touch](touch-class)\>
other) → [List](../dart-core/list-class)\<[Touch](touch-class)\>
...
[operator \[\]](touchlist/operator_get)([int](../dart-core/int-class)
index) → [Touch](touch-class)
...
[operator \[\]=](touchlist/operator_put)([int](../dart-core/int-class)
index, [Touch](touch-class) value) → void
...
[supported](touchlist/supported) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/TouchList-class.html>
:::
