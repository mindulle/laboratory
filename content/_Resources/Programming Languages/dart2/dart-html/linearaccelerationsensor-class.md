...
[LinearAccelerationSensor](linearaccelerationsensor/linearaccelerationsensor)(\[[Map](../dart-core/map-class)?
sensorOptions\])
...
[x](accelerometer/x) → [num](../dart-core/num-class)?

::: {.features}
read-only, inherited
:::

[y](accelerometer/y) → [num](../dart-core/num-class)?

::: {.features}
read-only, inherited
:::

[z](accelerometer/z) → [num](../dart-core/num-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-html/LinearAccelerationSensor-class.html>
:::
