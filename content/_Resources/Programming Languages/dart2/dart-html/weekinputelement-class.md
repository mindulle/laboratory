...
Use [supported](weekinputelement/supported) to check if this is
...
[WeekInputElement](weekinputelement/weekinputelement)()
...
[readOnly](weekinputelement/readonly) ↔ [bool](../dart-core/bool-class)?

::: {.features}
read / write
:::

[required](weekinputelement/required) ↔ [bool](../dart-core/bool-class)
...
[valueAsDate](weekinputelement/valueasdate) ↔
...
[supported](weekinputelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/WeekInputElement-class.html>
:::
