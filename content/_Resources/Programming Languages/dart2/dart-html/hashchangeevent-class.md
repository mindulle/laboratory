...
[HashChangeEvent](hashchangeevent/hashchangeevent)([String](../dart-core/string-class)
type, {[bool](../dart-core/bool-class) canBubble = true,
...
[newUrl](hashchangeevent/newurl) → [String](../dart-core/string-class)?

::: {.features}
\@JSName(\'newURL\'), read-only
:::

[oldUrl](hashchangeevent/oldurl) → [String](../dart-core/string-class)?

::: {.features}
\@JSName(\'oldURL\'), read-only
:::
...
[supported](hashchangeevent/supported) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/HashChangeEvent-class.html>
:::
