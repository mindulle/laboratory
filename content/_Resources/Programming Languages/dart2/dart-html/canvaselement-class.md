...
[CanvasElement](canvaselement/canvaselement)({[int](../dart-core/int-class)?
...
[CanvasElement.created](canvaselement/canvaselement.created)()
...
[height](canvaselement/height) ↔ [int](../dart-core/int-class)?
...
[onWebGlContextLost](canvaselement/onwebglcontextlost) →
...
[onWebGlContextRestored](canvaselement/onwebglcontextrestored) →
[ElementStream](elementstream-class)\<[ContextEvent](../dart-web_gl/contextevent-class)\>
...
[width](canvaselement/width) ↔ [int](../dart-core/int-class)?
...
[captureStream](canvaselement/capturestream)(\[[num](../dart-core/num-class)?
frameRate\]) → [MediaStream](mediastream-class)
...
[getContext](canvaselement/getcontext)([String](../dart-core/string-class)
contextId, \[[Map](../dart-core/map-class)? attributes\]) →
[Object](../dart-core/object-class)?
...
[getContext3d](canvaselement/getcontext3d)({dynamic alpha = true,
dynamic depth = true, dynamic stencil = false, dynamic antialias = true,
dynamic premultipliedAlpha = true, dynamic preserveDrawingBuffer =
false}) → [RenderingContext](../dart-web_gl/renderingcontext-class)?
...
[toBlob](canvaselement/toblob)(\[[String](../dart-core/string-class)?
type, [Object](../dart-core/object-class)? arguments\]) →
[Future](../dart-async/future-class)\<[Blob](blob-class)\>

[toDataUrl](canvaselement/todataurl)(\[[String](../dart-core/string-class)
type = \'image/png\', [num](../dart-core/num-class)? quality\]) →
[String](../dart-core/string-class)
...
[transferControlToOffscreen](canvaselement/transfercontroltooffscreen)()
...
[webGlContextLostEvent](canvaselement/webglcontextlostevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[ContextEvent](../dart-web_gl/contextevent-class)\>
...
[webGlContextRestoredEvent](canvaselement/webglcontextrestoredevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[ContextEvent](../dart-web_gl/contextevent-class)\>
:   Static factory designed to expose `webglcontextrestored` events to
...
<https://api.dart.dev/stable/2.18.5/dart-html/CanvasElement-class.html>
:::
