...
[PaymentRequestEvent](paymentrequestevent/paymentrequestevent)([String](../dart-core/string-class)
...
[instrumentKey](paymentrequestevent/instrumentkey) →
...
[List](../dart-core/list-class)?

::: {.features}
read-only
:::

[modifiers](paymentrequestevent/modifiers) →
[List](../dart-core/list-class)?
...
[paymentRequestOrigin](paymentrequestevent/paymentrequestorigin) →
[String](../dart-core/string-class)?
...
[topLevelOrigin](paymentrequestevent/toplevelorigin) →
[String](../dart-core/string-class)?
...
[openWindow](paymentrequestevent/openwindow)([String](../dart-core/string-class)
url) →
...
[respondWith](paymentrequestevent/respondwith)([Future](../dart-async/future-class)
response) → void
...
[waitUntil](extendableevent/waituntil)([Future](../dart-async/future-class)
f) → void
...
<https://api.dart.dev/stable/2.18.5/dart-html/PaymentRequestEvent-class.html>
:::
