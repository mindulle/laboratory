...
[OptionElement](optionelement/optionelement)({[String](../dart-core/string-class)
data = \'\', [String](../dart-core/string-class) value = \'\',
[bool](../dart-core/bool-class) selected = false})

::: {.constructor-modifier .features}
factory
:::

[OptionElement.created](optionelement/optionelement.created)()
...
[disabled](optionelement/disabled) ↔ [bool](../dart-core/bool-class)
...
[form](optionelement/form) → [FormElement](formelement-class)?
...
[index](optionelement/index) → [int](../dart-core/int-class)
...
[label](optionelement/label) ↔ [String](../dart-core/string-class)?
...
[selected](optionelement/selected) ↔ [bool](../dart-core/bool-class)
...
[value](optionelement/value) ↔ [String](../dart-core/string-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/OptionElement-class.html>
:::
