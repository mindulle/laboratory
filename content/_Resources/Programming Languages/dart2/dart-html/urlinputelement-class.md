...
Use [supported](urlinputelement/supported) to check if this is supported
...
[UrlInputElement](urlinputelement/urlinputelement)()
...
[list](urlinputelement/list) → [Element](element-class)?
...
[supported](urlinputelement/supported) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/UrlInputElement-class.html>
:::
