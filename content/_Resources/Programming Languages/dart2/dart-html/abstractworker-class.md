...
[errorEvent](abstractworker/errorevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
...
<https://api.dart.dev/stable/2.18.5/dart-html/AbstractWorker-class.html>
:::
