...
:   -   [ListMixin](../dart-collection/listmixin-class)\<[Node](node-class)\>
    -   [ImmutableListMixin](immutablelistmixin-class)\<[Node](node-class)\>
...
[first](nodelist/first) ↔ [Node](node-class)
...
[last](nodelist/last) ↔ [Node](node-class)
...
[length](nodelist/length) ↔ [int](../dart-core/int-class)
...
[single](nodelist/single) → [Node](node-class)
...
[elementAt](nodelist/elementat)([int](../dart-core/int-class) index) →
[Node](node-class)
...
[operator \[\]](nodelist/operator_get)([int](../dart-core/int-class)
...
[operator \[\]=](nodelist/operator_put)([int](../dart-core/int-class)
index, [Node](node-class) value) → void
...
<https://api.dart.dev/stable/2.18.5/dart-html/NodeList-class.html>
:::
