...
[MessageEvent](messageevent/messageevent)([String](../dart-core/string-class)
...
[data](messageevent/data) → dynamic
...
[origin](messageevent/origin) → [String](../dart-core/string-class)
...
::: {.features}
\@Unstable(), \@Creates(\'JSExtendableArray\'), read-only
:::
...
[source](messageevent/source) → [EventTarget](eventtarget-class)?

::: {.features}
read-only
:::

[suborigin](messageevent/suborigin) →
[String](../dart-core/string-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-html/MessageEvent-class.html>
:::
