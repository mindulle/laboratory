...
[OutputElement](outputelement/outputelement)()

::: {.constructor-modifier .features}
factory
:::

[OutputElement.created](outputelement/outputelement.created)()
...
[defaultValue](outputelement/defaultvalue) ↔
[String](../dart-core/string-class)?
...
[form](outputelement/form) → [FormElement](formelement-class)?
...
[htmlFor](outputelement/htmlfor) → [DomTokenList](domtokenlist-class)?
...
[name](outputelement/name) ↔ [String](../dart-core/string-class)?
...
[type](outputelement/type) → [String](../dart-core/string-class)?

::: {.features}
read-only
:::

[validationMessage](outputelement/validationmessage) →
[String](../dart-core/string-class)?
...
[validity](outputelement/validity) →
...
[value](outputelement/value) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write
:::

[willValidate](outputelement/willvalidate) →
[bool](../dart-core/bool-class)?
...
[checkValidity](outputelement/checkvalidity)() →
[bool](../dart-core/bool-class)
...
[reportValidity](outputelement/reportvalidity)() →
[bool](../dart-core/bool-class)
...
[setCustomValidity](outputelement/setcustomvalidity)([String](../dart-core/string-class)
error) → void
...
[supported](outputelement/supported) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/OutputElement-class.html>
:::
