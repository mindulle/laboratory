...
The [DivElement](divelement-class) is a generic container and does not
have any semantic significance. It is functionally similar to
[SpanElement](spanelement-class).

The [DivElement](divelement-class) is a block-level element, as opposed
to [SpanElement](spanelement-class), which is an inline-level element.
...
-   [HTML `<div>` element](http://www.w3.org/TR/html-markup/div.html)
    from W3C.
-   [Block-level
    element](http://www.w3.org/TR/CSS2/visuren.html#block-boxes) from
    W3C.
-   [Inline-level
    element](http://www.w3.org/TR/CSS2/visuren.html#inline-boxes) from
    W3C.
...
[DivElement.created](divelement/divelement.created)()
...
<https://api.dart.dev/stable/2.18.5/dart-html/DivElement-class.html>
:::
