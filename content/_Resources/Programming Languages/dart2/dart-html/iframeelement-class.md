...
[IFrameElement.created](iframeelement/iframeelement.created)()
...
[allow](iframeelement/allow) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write
:::

[allowFullscreen](iframeelement/allowfullscreen) ↔
...
[allowPaymentRequest](iframeelement/allowpaymentrequest) ↔
[bool](../dart-core/bool-class)?
...
[csp](iframeelement/csp) ↔ [String](../dart-core/string-class)?
...
[height](iframeelement/height) ↔ [String](../dart-core/string-class)?
...
[name](iframeelement/name) ↔ [String](../dart-core/string-class)?
...
[referrerPolicy](iframeelement/referrerpolicy) ↔
[String](../dart-core/string-class)?
...
[sandbox](iframeelement/sandbox) → [DomTokenList](domtokenlist-class)?
...
[src](iframeelement/src) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write
:::

[srcdoc](iframeelement/srcdoc) ↔ [String](../dart-core/string-class)?
...
[width](iframeelement/width) ↔ [String](../dart-core/string-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-html/IFrameElement-class.html>
:::
