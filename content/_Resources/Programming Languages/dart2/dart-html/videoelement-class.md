...
[VideoElement.created](videoelement/videoelement.created)()
...
[decodedFrameCount](videoelement/decodedframecount) →
[int](../dart-core/int-class)?
...
[droppedFrameCount](videoelement/droppedframecount) →
[int](../dart-core/int-class)?
...
[height](videoelement/height) ↔ [int](../dart-core/int-class)
...
[poster](videoelement/poster) ↔ [String](../dart-core/string-class)
...
[videoHeight](videoelement/videoheight) → [int](../dart-core/int-class)
...
[videoWidth](videoelement/videowidth) → [int](../dart-core/int-class)
...
[width](videoelement/width) ↔ [int](../dart-core/int-class)
...
[enterFullscreen](videoelement/enterfullscreen)() → void
...
[exitFullscreen](videoelement/exitfullscreen)() → void
...
[getVideoPlaybackQuality](videoelement/getvideoplaybackquality)() →
...
<https://api.dart.dev/stable/2.18.5/dart-html/VideoElement-class.html>
:::
