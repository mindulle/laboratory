...
[MediaElement.created](mediaelement/mediaelement.created)()
...
[audioDecodedByteCount](mediaelement/audiodecodedbytecount) →
...
[audioTracks](mediaelement/audiotracks) →
...
[autoplay](mediaelement/autoplay) ↔ [bool](../dart-core/bool-class)
...
[buffered](mediaelement/buffered) → [TimeRanges](timeranges-class)
...
[controls](mediaelement/controls) ↔ [bool](../dart-core/bool-class)

::: {.features}
read / write
:::

[controlsList](mediaelement/controlslist) →
...
[currentTime](mediaelement/currenttime) ↔ [num](../dart-core/num-class)
...
[disableRemotePlayback](mediaelement/disableremoteplayback) ↔
[bool](../dart-core/bool-class)
...
[duration](mediaelement/duration) → [num](../dart-core/num-class)

::: {.features}
read-only
:::

[ended](mediaelement/ended) → [bool](../dart-core/bool-class)

::: {.features}
read-only
:::

[error](mediaelement/error) → [MediaError](mediaerror-class)?
...
[loop](mediaelement/loop) ↔ [bool](../dart-core/bool-class)
...
[mediaKeys](mediaelement/mediakeys) → [MediaKeys](mediakeys-class)?

::: {.features}
read-only
:::

[muted](mediaelement/muted) ↔ [bool](../dart-core/bool-class)
...
[paused](mediaelement/paused) → [bool](../dart-core/bool-class)
...
[played](mediaelement/played) → [TimeRanges](timeranges-class)

::: {.features}
read-only
:::

[preload](mediaelement/preload) ↔ [String](../dart-core/string-class)
...
[readyState](mediaelement/readystate) → [int](../dart-core/int-class)

::: {.features}
read-only
:::

[remote](mediaelement/remote) → [RemotePlayback](remoteplayback-class)?
...
[seekable](mediaelement/seekable) → [TimeRanges](timeranges-class)

::: {.features}
read-only
:::

[seeking](mediaelement/seeking) → [bool](../dart-core/bool-class)
...
[sinkId](mediaelement/sinkid) → [String](../dart-core/string-class)?
...
[src](mediaelement/src) ↔ [String](../dart-core/string-class)

::: {.features}
read / write
:::

[srcObject](mediaelement/srcobject) ↔ [MediaStream](mediastream-class)?
...
[videoDecodedByteCount](mediaelement/videodecodedbytecount) →
[int](../dart-core/int-class)?
...
[videoTracks](mediaelement/videotracks) →
...
[volume](mediaelement/volume) ↔ [num](../dart-core/num-class)
...
[addTextTrack](mediaelement/addtexttrack)([String](../dart-core/string-class)
kind, \[[String](../dart-core/string-class)? label,
...
[canPlayType](mediaelement/canplaytype)([String](../dart-core/string-class)?
type, \[[String](../dart-core/string-class)? keySystem\]) →
[String](../dart-core/string-class)
...
[captureStream](mediaelement/capturestream)() →
...
[pause](mediaelement/pause)() → void

[play](mediaelement/play)() → [Future](../dart-async/future-class)
...
[setMediaKeys](mediaelement/setmediakeys)([MediaKeys](mediakeys-class)?
mediaKeys) → [Future](../dart-async/future-class)
...
[setSinkId](mediaelement/setsinkid)([String](../dart-core/string-class)
sinkId) → [Future](../dart-async/future-class)
...
[HAVE\_CURRENT\_DATA](mediaelement/have_current_data-constant) → const [int](../dart-core/int-class)
...
[HAVE\_ENOUGH\_DATA](mediaelement/have_enough_data-constant) → const [int](../dart-core/int-class)
...
[HAVE\_FUTURE\_DATA](mediaelement/have_future_data-constant) → const [int](../dart-core/int-class)
...
[HAVE\_METADATA](mediaelement/have_metadata-constant) → const [int](../dart-core/int-class)
...
[HAVE\_NOTHING](mediaelement/have_nothing-constant) → const [int](../dart-core/int-class)
...
[NETWORK\_EMPTY](mediaelement/network_empty-constant) → const [int](../dart-core/int-class)
...
[NETWORK\_IDLE](mediaelement/network_idle-constant) → const [int](../dart-core/int-class)
...
[NETWORK\_LOADING](mediaelement/network_loading-constant) → const [int](../dart-core/int-class)
...
[NETWORK\_NO\_SOURCE](mediaelement/network_no_source-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/MediaElement-class.html>
:::
