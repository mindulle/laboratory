...
Use [supported](telephoneinputelement/supported) to check if this is
...
[TelephoneInputElement](telephoneinputelement/telephoneinputelement)()
...
[list](telephoneinputelement/list) → [Element](element-class)?
...
[supported](telephoneinputelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/TelephoneInputElement-class.html>
:::
