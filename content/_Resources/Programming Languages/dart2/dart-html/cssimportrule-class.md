...
[href](cssimportrule/href) → [String](../dart-core/string-class)?

::: {.features}
read-only
:::

[media](cssimportrule/media) → [MediaList](medialist-class)?
...
[styleSheet](cssimportrule/stylesheet) →
[CssStyleSheet](cssstylesheet-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-html/CssImportRule-class.html>
:::
