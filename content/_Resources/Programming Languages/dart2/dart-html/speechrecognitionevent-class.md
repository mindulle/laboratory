...
[SpeechRecognitionEvent](speechrecognitionevent/speechrecognitionevent)([String](../dart-core/string-class)
type, \[[Map](../dart-core/map-class)? initDict\])
...
[emma](speechrecognitionevent/emma) → [Document](document-class)?
...
[interpretation](speechrecognitionevent/interpretation) →
...
[resultIndex](speechrecognitionevent/resultindex) →
...
<https://api.dart.dev/stable/2.18.5/dart-html/SpeechRecognitionEvent-class.html>
:::
