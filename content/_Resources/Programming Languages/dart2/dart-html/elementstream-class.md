...
[ElementStream](elementstream/elementstream)()
...
[capture](elementstream/capture)(void onData(T event)) →
...
[matches](elementstream/matches)([String](../dart-core/string-class)
selector) → [Stream](../dart-async/stream-class)\<T\>
...
<https://api.dart.dev/stable/2.18.5/dart-html/ElementStream-class.html>
:::
