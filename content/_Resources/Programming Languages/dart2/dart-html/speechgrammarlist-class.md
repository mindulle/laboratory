...
:   -   [List](../dart-core/list-class)\<[SpeechGrammar](speechgrammar-class)\>

Mixed in types

:   -   [ListMixin](../dart-collection/listmixin-class)\<[SpeechGrammar](speechgrammar-class)\>
    -   [ImmutableListMixin](immutablelistmixin-class)\<[SpeechGrammar](speechgrammar-class)\>
...
[first](speechgrammarlist/first) ↔ [SpeechGrammar](speechgrammar-class)
...
[Iterator](../dart-core/iterator-class)\<[SpeechGrammar](speechgrammar-class)\>
...
[last](speechgrammarlist/last) ↔ [SpeechGrammar](speechgrammar-class)
...
[length](speechgrammarlist/length) ↔ [int](../dart-core/int-class)
...
[Iterable](../dart-core/iterable-class)\<[SpeechGrammar](speechgrammar-class)\>
...
[single](speechgrammarlist/single) →
...
[add](immutablelistmixin/add)([SpeechGrammar](speechgrammar-class)
value) → void
...
[addAll](immutablelistmixin/addall)([Iterable](../dart-core/iterable-class)\<[SpeechGrammar](speechgrammar-class)\>
iterable) → void
...
[addFromString](speechgrammarlist/addfromstring)([String](../dart-core/string-class)
string, \[[num](../dart-core/num-class)? weight\]) → void

[addFromUri](speechgrammarlist/addfromuri)([String](../dart-core/string-class)
src, \[[num](../dart-core/num-class)? weight\]) → void

[any](../dart-collection/listmixin/any)([bool](../dart-core/bool-class)
test([SpeechGrammar](speechgrammar-class) element)) →
[bool](../dart-core/bool-class)
...
[elementAt](speechgrammarlist/elementat)([int](../dart-core/int-class)
index) → [SpeechGrammar](speechgrammar-class)
...
f([SpeechGrammar](speechgrammar-class) element)) →
...
\[[SpeechGrammar](speechgrammar-class)? fillValue\]) → void
...
test([SpeechGrammar](speechgrammar-class) element),
{[SpeechGrammar](speechgrammar-class) orElse()?}) →
[SpeechGrammar](speechgrammar-class)
...
combine(T previousValue, [SpeechGrammar](speechgrammar-class) element))
→ T
...
[followedBy](../dart-collection/listmixin/followedby)([Iterable](../dart-core/iterable-class)\<[SpeechGrammar](speechgrammar-class)\>
other) →
[Iterable](../dart-core/iterable-class)\<[SpeechGrammar](speechgrammar-class)\>
...
action([SpeechGrammar](speechgrammar-class) element)) → void
...
[SpeechGrammar](speechgrammar-class) element) → void
...
[item](speechgrammarlist/item)([int](../dart-core/int-class) index) →
[SpeechGrammar](speechgrammar-class)
...
[reduce](../dart-collection/listmixin/reduce)([SpeechGrammar](speechgrammar-class)
combine([SpeechGrammar](speechgrammar-class) previousValue,
[SpeechGrammar](speechgrammar-class) element)) →
[SpeechGrammar](speechgrammar-class)
...
pos) → [SpeechGrammar](speechgrammar-class)
...
test([SpeechGrammar](speechgrammar-class) element)) → void
...
compare([SpeechGrammar](speechgrammar-class) a,
[SpeechGrammar](speechgrammar-class) b)?\]) → void
...
[Set](../dart-core/set-class)\<[SpeechGrammar](speechgrammar-class)\>
...
[operator
+](../dart-collection/listmixin/operator_plus)([List](../dart-core/list-class)\<[SpeechGrammar](speechgrammar-class)\>
other) →
[List](../dart-core/list-class)\<[SpeechGrammar](speechgrammar-class)\>
...
[operator
\[\]](speechgrammarlist/operator_get)([int](../dart-core/int-class)
index) → [SpeechGrammar](speechgrammar-class)
...
[operator
\[\]=](speechgrammarlist/operator_put)([int](../dart-core/int-class)
index, [SpeechGrammar](speechgrammar-class) value) → void
...
<https://api.dart.dev/stable/2.18.5/dart-html/SpeechGrammarList-class.html>
:::
