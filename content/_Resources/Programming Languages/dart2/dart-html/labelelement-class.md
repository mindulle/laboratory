...
[LabelElement.created](labelelement/labelelement.created)()
...
[control](labelelement/control) → [HtmlElement](htmlelement-class)?
...
[form](labelelement/form) → [FormElement](formelement-class)?
...
[htmlFor](labelelement/htmlfor) ↔ [String](../dart-core/string-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/LabelElement-class.html>
:::
