...
[TableRowElement](tablerowelement/tablerowelement)()

::: {.constructor-modifier .features}
factory
:::

[TableRowElement.created](tablerowelement/tablerowelement.created)()
...
[rowIndex](tablerowelement/rowindex) → [int](../dart-core/int-class)
...
[sectionRowIndex](tablerowelement/sectionrowindex) →
...
[addCell](tablerowelement/addcell)() →
[TableCellElement](tablecellelement-class)
...
[createFragment](tablerowelement/createfragment)([String](../dart-core/string-class)?
...
[deleteCell](tablerowelement/deletecell)([int](../dart-core/int-class)
index) → void
...
[insertCell](tablerowelement/insertcell)([int](../dart-core/int-class)
index) → [TableCellElement](tablecellelement-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/TableRowElement-class.html>
:::
