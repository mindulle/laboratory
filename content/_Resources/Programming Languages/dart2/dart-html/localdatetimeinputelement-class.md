...
LocalDateTimeInputElement class
===============================

A date and time (year, month, day, hour, minute, second, fraction of a
second) with no time zone.

Use [supported](localdatetimeinputelement/supported) to check if this is
...
[LocalDateTimeInputElement](localdatetimeinputelement/localdatetimeinputelement)()
...
[readOnly](localdatetimeinputelement/readonly) ↔
[bool](../dart-core/bool-class)?
...
[required](localdatetimeinputelement/required) ↔
[bool](../dart-core/bool-class)
...
[supported](localdatetimeinputelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/LocalDateTimeInputElement-class.html>
:::
