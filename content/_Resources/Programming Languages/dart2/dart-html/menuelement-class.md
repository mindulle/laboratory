...
element represents an unordered list of menu commands.

See also:

-   [Menu
    Element](https://developer.mozilla.org/en-US/docs/HTML/Element/menu)
    from MDN.
-   [Menu
    Element](http://www.w3.org/TR/html5/the-menu-element.html#the-menu-element)
    from the W3C.
...
[MenuElement.created](menuelement/menuelement.created)()
...
<https://api.dart.dev/stable/2.18.5/dart-html/MenuElement-class.html>
:::
