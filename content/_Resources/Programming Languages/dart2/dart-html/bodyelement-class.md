...
[BodyElement.created](bodyelement/bodyelement.created)()
...
[onHashChange](bodyelement/onhashchange) →
[ElementStream](elementstream-class)\<[Event](event-class)\>
...
[onMessage](bodyelement/onmessage) →
...
[onOffline](bodyelement/onoffline) →
[ElementStream](elementstream-class)\<[Event](event-class)\>
...
[onPopState](bodyelement/onpopstate) →
...
[onStorage](bodyelement/onstorage) →
...
[blurEvent](bodyelement/blurevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
...
[errorEvent](bodyelement/errorevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
...
[focusEvent](bodyelement/focusevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
...
[hashChangeEvent](bodyelement/hashchangeevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
...
[loadEvent](bodyelement/loadevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
...
[messageEvent](bodyelement/messageevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[MessageEvent](messageevent-class)\>
...
[offlineEvent](bodyelement/offlineevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
...
[onlineEvent](bodyelement/onlineevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
:   Static factory designed to expose `online` events to event handlers
    that are not necessarily instances of
    [BodyElement](bodyelement-class).
    <div>
...
[popStateEvent](bodyelement/popstateevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[PopStateEvent](popstateevent-class)\>
...
[resizeEvent](bodyelement/resizeevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
:   Static factory designed to expose `resize` events to event handlers
    that are not necessarily instances of
    [BodyElement](bodyelement-class).
    <div>
...
[scrollEvent](bodyelement/scrollevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
...
[storageEvent](bodyelement/storageevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[StorageEvent](storageevent-class)\>
...
[unloadEvent](bodyelement/unloadevent-constant) → const [EventStreamProvider](eventstreamprovider-class)\<[Event](event-class)\>
:   Static factory designed to expose `unload` events to event handlers
    that are not necessarily instances of
    [BodyElement](bodyelement-class).
    <div>
