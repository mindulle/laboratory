...
[LinkElement.created](linkelement/linkelement.created)()
...
[as](linkelement/as) ↔ [String](../dart-core/string-class)?
...
[disabled](linkelement/disabled) ↔ [bool](../dart-core/bool-class)?
...
[href](linkelement/href) ↔ [String](../dart-core/string-class)

::: {.features}
read / write
:::

[hreflang](linkelement/hreflang) ↔ [String](../dart-core/string-class)
...
[import](linkelement/import) → [Document](document-class)?
...
[integrity](linkelement/integrity) ↔
[String](../dart-core/string-class)?
...
[media](linkelement/media) ↔ [String](../dart-core/string-class)
...
[referrerPolicy](linkelement/referrerpolicy) ↔
[String](../dart-core/string-class)?
...
[rel](linkelement/rel) ↔ [String](../dart-core/string-class)

::: {.features}
read / write
:::

[relList](linkelement/rellist) → [DomTokenList](domtokenlist-class)?
...
[scope](linkelement/scope) ↔ [String](../dart-core/string-class)?
...
[sheet](linkelement/sheet) → [StyleSheet](stylesheet-class)?

::: {.features}
read-only
:::

[sizes](linkelement/sizes) → [DomTokenList](domtokenlist-class)?
...
[supportsImport](linkelement/supportsimport) →
[bool](../dart-core/bool-class)
...
[type](linkelement/type) ↔ [String](../dart-core/string-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/LinkElement-class.html>
:::
