...
[TrackElement.created](trackelement/trackelement.created)()
...
[defaultValue](trackelement/defaultvalue) ↔
[bool](../dart-core/bool-class)?

::: {.features}
\@JSName(\'default\'), \@JSName(\'default\'), read / write
:::
...
[kind](trackelement/kind) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write
:::

[label](trackelement/label) ↔ [String](../dart-core/string-class)?
...
[readyState](trackelement/readystate) → [int](../dart-core/int-class)?
...
[src](trackelement/src) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write
:::

[srclang](trackelement/srclang) ↔ [String](../dart-core/string-class)?
...
[track](trackelement/track) → [TextTrack](texttrack-class)?
...
[supported](trackelement/supported) → [bool](../dart-core/bool-class)
...
[ERROR](trackelement/error-constant) → const [int](../dart-core/int-class)
...
[LOADED](trackelement/loaded-constant) → const [int](../dart-core/int-class)
...
[LOADING](trackelement/loading-constant) → const [int](../dart-core/int-class)
...
[NONE](trackelement/none-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/TrackElement-class.html>
:::
