...
[data](extendablemessageevent/data) →
[Object](../dart-core/object-class)?
...
[lastEventId](extendablemessageevent/lasteventid) →
...
[ports](extendablemessageevent/ports) →
...
\@Returns(\'Client\|ServiceWorker\|MessagePort\|Null\'), read-only
:::
...
<https://api.dart.dev/stable/2.18.5/dart-html/ExtendableMessageEvent-class.html>
:::
