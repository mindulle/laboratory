...
Use [supported](searchinputelement/supported) to check if this is
...
[SearchInputElement](searchinputelement/searchinputelement)()
...
[autocomplete](textinputelementbase/autocomplete) ↔
[String](../dart-core/string-class)
...
[dirName](searchinputelement/dirname) ↔
[String](../dart-core/string-class)?
...
[list](searchinputelement/list) → [Element](element-class)?
...
[maxLength](textinputelementbase/maxlength) ↔
...
[pattern](textinputelementbase/pattern) ↔
[String](../dart-core/string-class)
...
[placeholder](textinputelementbase/placeholder) ↔
[String](../dart-core/string-class)
...
[readOnly](textinputelementbase/readonly) ↔
[bool](../dart-core/bool-class)?
...
[required](textinputelementbase/required) ↔
[bool](../dart-core/bool-class)
...
[size](textinputelementbase/size) ↔ [int](../dart-core/int-class)?
...
[supported](searchinputelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/SearchInputElement-class.html>
:::
