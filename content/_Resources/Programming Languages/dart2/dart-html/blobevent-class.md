...
[BlobEvent](blobevent/blobevent)([String](../dart-core/string-class)
...
[data](blobevent/data) → [Blob](blob-class)?
...
[timecode](blobevent/timecode) → [num](../dart-core/num-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-html/BlobEvent-class.html>
:::
