...
[FormElement.created](formelement/formelement.created)()
...
[acceptCharset](formelement/acceptcharset) ↔
...
[action](formelement/action) ↔ [String](../dart-core/string-class)?
...
[encoding](formelement/encoding) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write
:::

[enctype](formelement/enctype) ↔ [String](../dart-core/string-class)?
...
[length](formelement/length) → [int](../dart-core/int-class)?
...
[method](formelement/method) ↔ [String](../dart-core/string-class)?

::: {.features}
read / write
:::

[name](formelement/name) ↔ [String](../dart-core/string-class)?
...
[noValidate](formelement/novalidate) ↔ [bool](../dart-core/bool-class)?
...
[target](formelement/target) ↔ [String](../dart-core/string-class)?
...
[item](formelement/item)([int](../dart-core/int-class) index) →
[Element](element-class)
...
[reportValidity](formelement/reportvalidity)() →
[bool](../dart-core/bool-class)

[requestAutocomplete](formelement/requestautocomplete)([Map](../dart-core/map-class)?
details) → void
...
[submit](formelement/submit)() → void
...
<https://api.dart.dev/stable/2.18.5/dart-html/FormElement-class.html>
:::
