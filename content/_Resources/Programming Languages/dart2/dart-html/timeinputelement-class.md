...
Use [supported](timeinputelement/supported) to check if this is
...
[TimeInputElement](timeinputelement/timeinputelement)()
...
[readOnly](timeinputelement/readonly) ↔ [bool](../dart-core/bool-class)?

::: {.features}
read / write
:::

[required](timeinputelement/required) ↔ [bool](../dart-core/bool-class)
...
[valueAsDate](timeinputelement/valueasdate) ↔
...
[supported](timeinputelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-html/TimeInputElement-class.html>
:::
