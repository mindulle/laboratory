...
:   -   [List](../dart-core/list-class)\<[Plugin](plugin-class)\>

Mixed in types

:   -   [ListMixin](../dart-collection/listmixin-class)\<[Plugin](plugin-class)\>
    -   [ImmutableListMixin](immutablelistmixin-class)\<[Plugin](plugin-class)\>
...
[first](pluginarray/first) ↔ [Plugin](plugin-class)
...
[Iterator](../dart-core/iterator-class)\<[Plugin](plugin-class)\>
...
[last](pluginarray/last) ↔ [Plugin](plugin-class)
...
[length](pluginarray/length) ↔ [int](../dart-core/int-class)
...
[Iterable](../dart-core/iterable-class)\<[Plugin](plugin-class)\>
...
[single](pluginarray/single) → [Plugin](plugin-class)
...
[add](immutablelistmixin/add)([Plugin](plugin-class) value) → void
...
[addAll](immutablelistmixin/addall)([Iterable](../dart-core/iterable-class)\<[Plugin](plugin-class)\>
iterable) → void
...
test([Plugin](plugin-class) element)) → [bool](../dart-core/bool-class)
...
[elementAt](pluginarray/elementat)([int](../dart-core/int-class) index)
→ [Plugin](plugin-class)
...
start, [int](../dart-core/int-class) end, \[[Plugin](plugin-class)?
fillValue\]) → void
...
test([Plugin](plugin-class) element), {[Plugin](plugin-class)
orElse()?}) → [Plugin](plugin-class)
...
combine(T previousValue, [Plugin](plugin-class) element)) → T
...
[followedBy](../dart-collection/listmixin/followedby)([Iterable](../dart-core/iterable-class)\<[Plugin](plugin-class)\>
other) →
[Iterable](../dart-core/iterable-class)\<[Plugin](plugin-class)\>
...
action([Plugin](plugin-class) element)) → void
...
test([Plugin](plugin-class) element), \[[int](../dart-core/int-class)
...
[Plugin](plugin-class) element) → void
...
index, [Iterable](../dart-core/iterable-class)\<[Plugin](plugin-class)\>
iterable) → void
...
[item](pluginarray/item)([int](../dart-core/int-class) index) →
[Plugin](plugin-class)?
...
[map](../dart-collection/listmixin/map)\<T\>(T f([Plugin](plugin-class)
...
[namedItem](pluginarray/nameditem)([String](../dart-core/string-class)
name) → [Plugin](plugin-class)?
...
[reduce](../dart-collection/listmixin/reduce)([Plugin](plugin-class)
combine([Plugin](plugin-class) previousValue, [Plugin](plugin-class)
element)) → [Plugin](plugin-class)
...
[refresh](pluginarray/refresh)([bool](../dart-core/bool-class)? reload)
→ void
...
[removeLast](immutablelistmixin/removelast)() → [Plugin](plugin-class)
...
test([Plugin](plugin-class) element)) → void
...
test([Plugin](plugin-class) element)) →
[Iterable](../dart-core/iterable-class)\<[Plugin](plugin-class)\>
...
compare([Plugin](plugin-class) a, [Plugin](plugin-class) b)?\]) → void
...
[Set](../dart-core/set-class)\<[Plugin](plugin-class)\>
...
[operator
+](../dart-collection/listmixin/operator_plus)([List](../dart-core/list-class)\<[Plugin](plugin-class)\>
other) → [List](../dart-core/list-class)\<[Plugin](plugin-class)\>
...
[operator \[\]](pluginarray/operator_get)([int](../dart-core/int-class)
index) → [Plugin](plugin-class)
...
[operator \[\]=](pluginarray/operator_put)([int](../dart-core/int-class)
index, [Plugin](plugin-class) value) → void
...
<https://api.dart.dev/stable/2.18.5/dart-html/PluginArray-class.html>
:::
