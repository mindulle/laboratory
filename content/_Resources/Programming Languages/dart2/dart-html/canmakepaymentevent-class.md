...
[CanMakePaymentEvent](canmakepaymentevent/canmakepaymentevent)([String](../dart-core/string-class)
...
[methodData](canmakepaymentevent/methoddata) →
...
[modifiers](canmakepaymentevent/modifiers) →
[List](../dart-core/list-class)?
...
[paymentRequestOrigin](canmakepaymentevent/paymentrequestorigin) →
...
[topLevelOrigin](canmakepaymentevent/toplevelorigin) →
[String](../dart-core/string-class)?
...
[respondWith](canmakepaymentevent/respondwith)([Future](../dart-async/future-class)
canMakePaymentResponse) → void
...
<https://api.dart.dev/stable/2.18.5/dart-html/CanMakePaymentEvent-class.html>
:::
