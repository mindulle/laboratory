...
[format](httpdate/format)([DateTime](../dart-core/datetime-class) date) → [String](../dart-core/string-class)
:   Format a date according to
    [RFC-1123](http://tools.ietf.org/html/rfc1123 "RFC-1123"), e.g.
    `Thu, 1 Jan 1970 00:00:00 GMT`.

[parse](httpdate/parse)([String](../dart-core/string-class) date) → [DateTime](../dart-core/datetime-class)
...
<https://api.dart.dev/stable/2.18.5/dart-io/HttpDate-class.html>
:::
