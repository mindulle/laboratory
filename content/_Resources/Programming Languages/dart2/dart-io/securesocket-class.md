...
A secure socket may be used as either a
[Stream](../dart-async/stream-class) or an [IOSink](iosink-class).
...
[peerCertificate](securesocket/peercertificate) →
...
[renegotiate](securesocket/renegotiate){.deprecated}({[bool](../dart-core/bool-class)
...
[connect](securesocket/connect)(dynamic host,
...
[secure](securesocket/secure)([Socket](socket-class) socket, {dynamic
host, [SecurityContext](securitycontext-class)? context,
[bool](../dart-core/bool-class)
onBadCertificate([X509Certificate](x509certificate-class) certificate)?,
void keyLog([String](../dart-core/string-class) line)?,
[List](../dart-core/list-class)\<[String](../dart-core/string-class)\>?
...
[secureServer](securesocket/secureserver)([Socket](socket-class) socket,
[SecurityContext](securitycontext-class)? context,
...
[startConnect](securesocket/startconnect)(dynamic host,
[int](../dart-core/int-class) port,
{[SecurityContext](securitycontext-class)? context,
[bool](../dart-core/bool-class)
onBadCertificate([X509Certificate](x509certificate-class) certificate)?,
...
Like [connect](securesocket/connect), but returns a
...
<https://api.dart.dev/stable/2.18.5/dart-io/SecureSocket-class.html>
:::
