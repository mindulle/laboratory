...
Creates an [Int8List](../int8list-class) *view* of the specified region
in `buffer`.

Changes in the [Int8List](../int8list-class) will be visible in the byte
...
Merely doing `Int8List.view(other.buffer, 0, count)` may not point to
...
Alternatively, use [Int8List.sublistView](int8list.sublistview) which
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Int8List/Int8List.view.html>
:::
