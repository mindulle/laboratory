...
Creates a [Uint8List](../uint8list-class) *view* of the specified region
in `buffer`.
...
Merely doing `Uint8List.view(other.buffer, 0, count)` may not point to
...
Alternatively, use [Uint8List.sublistView](uint8list.sublistview) which
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Uint8List/Uint8List.view.html>
:::
