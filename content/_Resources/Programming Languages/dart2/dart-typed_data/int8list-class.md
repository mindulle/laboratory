...
interpreted as a signed 8-bit two\'s complement integer with values in
...
[Int8List](int8list/int8list)([int](../dart-core/int-class) length)
...
[Int8List.fromList](int8list/int8list.fromlist)([List](../dart-core/list-class)\<[int](../dart-core/int-class)\>
elements)
...
[Int8List.sublistView](int8list/int8list.sublistview)([TypedData](typeddata-class)
...
[Int8List.view](int8list/int8list.view)([ByteBuffer](bytebuffer-class)
...
Creates an [Int8List](int8list-class) *view* of the specified region in
`buffer`.
...
[sublist](int8list/sublist)([int](../dart-core/int-class) start,
\[[int](../dart-core/int-class)? end\]) → [Int8List](int8list-class)
...
[bytesPerElement](int8list/bytesperelement-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Int8List-class.html>
:::
