...
[Int32x4List](int32x4list/int32x4list)([int](../dart-core/int-class)
length)
...
Creates a [Int32x4List](int32x4list-class) of the specified length (in
elements), all of whose elements are initially zero.

[Int32x4List.fromList](int32x4list/int32x4list.fromlist)([List](../dart-core/list-class)\<[Int32x4](int32x4-class)\>
elements)
...
Creates a [Int32x4List](int32x4list-class) with the same length as the
`elements` list and copies over the elements.

[Int32x4List.sublistView](int32x4list/int32x4list.sublistview)([TypedData](typeddata-class)
...
Creates an [Int32x4List](int32x4list-class) view on a range of elements
of `data`.

[Int32x4List.view](int32x4list/int32x4list.view)([ByteBuffer](bytebuffer-class)
...
Creates a [Int32x4List](int32x4list-class) *view* of the specified
region in `buffer`.
...
[first](../dart-core/iterable/first) ↔ [Int32x4](int32x4-class)
...
[last](../dart-core/iterable/last) ↔ [Int32x4](int32x4-class)
...
[single](../dart-core/iterable/single) → [Int32x4](int32x4-class)
...
[add](../dart-core/list/add)([Int32x4](int32x4-class) value) → void
...
[addAll](../dart-core/list/addall)([Iterable](../dart-core/iterable-class)\<[Int32x4](int32x4-class)\>
iterable) → void
...
toElements([Int32x4](int32x4-class) element)) →
...
previousValue, [Int32x4](int32x4-class) element)) → T
...
[followedBy](../dart-core/iterable/followedby)([Iterable](../dart-core/iterable-class)\<[Int32x4](int32x4-class)\>
other) →
[Iterable](../dart-core/iterable-class)\<[Int32x4](int32x4-class)\>
...
[indexOf](../dart-core/list/indexof)([Int32x4](int32x4-class) element,
...
[Int32x4](int32x4-class) element) → void
...
[lastIndexOf](../dart-core/list/lastindexof)([Int32x4](int32x4-class)
...
toElement([Int32x4](int32x4-class) e)) →
[Iterable](../dart-core/iterable-class)\<T\>
...
[reduce](../dart-core/iterable/reduce)([Int32x4](int32x4-class)
combine([Int32x4](int32x4-class) value, [Int32x4](int32x4-class)
...
[removeLast](../dart-core/list/removelast)() → [Int32x4](int32x4-class)
...
test([Int32x4](int32x4-class) value)) →
[Iterable](../dart-core/iterable-class)\<[Int32x4](int32x4-class)\>
...
compare([Int32x4](int32x4-class) a, [Int32x4](int32x4-class) b)?\]) →
void
...
[sublist](int32x4list/sublist)([int](../dart-core/int-class) start,
\[[int](../dart-core/int-class)? end\]) →
...
[operator
+](int32x4list/operator_plus)([List](../dart-core/list-class)\<[Int32x4](int32x4-class)\>
...
[bytesPerElement](int32x4list/bytesperelement-constant) → const [int](../dart-core/int-class)
