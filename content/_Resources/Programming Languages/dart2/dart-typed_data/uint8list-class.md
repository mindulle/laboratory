...
interpreted as an unsigned 8-bit integer with values in the range 0 to
255.
...
[Uint8List](uint8list/uint8list)([int](../dart-core/int-class) length)
...
[Uint8List.fromList](uint8list/uint8list.fromlist)([List](../dart-core/list-class)\<[int](../dart-core/int-class)\>
elements)
...
[Uint8List.sublistView](uint8list/uint8list.sublistview)([TypedData](typeddata-class)
...
Creates a [Uint8List](uint8list-class) view on a range of elements of
`data`.

[Uint8List.view](uint8list/uint8list.view)([ByteBuffer](bytebuffer-class)
...
Creates a [Uint8List](uint8list-class) *view* of the specified region in
`buffer`.
...
[sublist](uint8list/sublist)([int](../dart-core/int-class) start,
\[[int](../dart-core/int-class)? end\]) → [Uint8List](uint8list-class)
...
[operator
+](uint8list/operator_plus)([List](../dart-core/list-class)\<[int](../dart-core/int-class)\>
other) →
[List](../dart-core/list-class)\<[int](../dart-core/int-class)\>
...
[bytesPerElement](uint8list/bytesperelement-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Uint8List-class.html>
:::
