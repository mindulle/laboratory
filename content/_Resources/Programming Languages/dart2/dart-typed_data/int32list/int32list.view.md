...
Creates an [Int32List](../int32list-class) *view* of the specified
region in `buffer`.

Changes in the [Int32List](../int32list-class) will be visible in the
...
Merely doing `Int32List.view(other.buffer, 0, count)` may not point to
...
Alternatively, use [Int32List.sublistView](int32list.sublistview) which
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Int32List/Int32List.view.html>
:::
