...
numbers that is viewable as a [TypedData](typeddata-class).
...
[Float32List](float32list/float32list)([int](../dart-core/int-class)
length)
...
Creates a [Float32List](float32list-class) of the specified length (in
elements), all of whose elements are initially zero.

[Float32List.fromList](float32list/float32list.fromlist)([List](../dart-core/list-class)\<[double](../dart-core/double-class)\>
elements)
...
Creates a [Float32List](float32list-class) with the same length as the
`elements` list and copies over the elements.

[Float32List.sublistView](float32list/float32list.sublistview)([TypedData](typeddata-class)
...
Creates an [Float32List](float32list-class) view on a range of elements
of `data`.

[Float32List.view](float32list/float32list.view)([ByteBuffer](bytebuffer-class)
...
Creates a [Float32List](float32list-class) *view* of the specified
region in `buffer`.
...
[last](../dart-core/iterable/last) ↔ [double](../dart-core/double-class)
...
[add](../dart-core/list/add)([double](../dart-core/double-class) value)
→ void
...
[addAll](../dart-core/list/addall)([Iterable](../dart-core/iterable-class)\<[double](../dart-core/double-class)\>
iterable) → void
...
toElements([double](../dart-core/double-class) element)) →
...
previousValue, [double](../dart-core/double-class) element)) → T
...
[followedBy](../dart-core/iterable/followedby)([Iterable](../dart-core/iterable-class)\<[double](../dart-core/double-class)\>
other) →
[Iterable](../dart-core/iterable-class)\<[double](../dart-core/double-class)\>
...
[indexOf](../dart-core/list/indexof)([double](../dart-core/double-class)
...
[double](../dart-core/double-class) element) → void
...
[lastIndexOf](../dart-core/list/lastindexof)([double](../dart-core/double-class)
...
toElement([double](../dart-core/double-class) e)) →
[Iterable](../dart-core/iterable-class)\<T\>
...
[reduce](../dart-core/iterable/reduce)([double](../dart-core/double-class)
combine([double](../dart-core/double-class) value,
...
test([double](../dart-core/double-class) value)) →
[Iterable](../dart-core/iterable-class)\<[double](../dart-core/double-class)\>
...
compare([double](../dart-core/double-class) a,
[double](../dart-core/double-class) b)?\]) → void
...
[sublist](float32list/sublist)([int](../dart-core/int-class) start,
\[[int](../dart-core/int-class)? end\]) →
...
[operator
+](../dart-core/list/operator_plus)([List](../dart-core/list-class)\<[double](../dart-core/double-class)\>
other) →
[List](../dart-core/list-class)\<[double](../dart-core/double-class)\>
...
[bytesPerElement](float32list/bytesperelement-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Float32List-class.html>
:::
