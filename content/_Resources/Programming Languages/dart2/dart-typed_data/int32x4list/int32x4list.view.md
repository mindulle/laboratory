...
Changes in the [Int32x4List](../int32x4list-class) will be visible in
...
Merely doing `Int32x4List.view(other.buffer, 0, count)` may not point to
...
Alternatively, use [Int32x4List.sublistView](int32x4list.sublistview)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Int32x4List/Int32x4List.view.html>
:::
