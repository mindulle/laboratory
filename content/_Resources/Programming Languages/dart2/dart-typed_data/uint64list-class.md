...
interpreted as an unsigned 64-bit integer with values in the range 0 to
...
[Uint64List](uint64list/uint64list)([int](../dart-core/int-class)
length)
...
[Uint64List.fromList](uint64list/uint64list.fromlist)([List](../dart-core/list-class)\<[int](../dart-core/int-class)\>
elements)
...
Creates a [Uint64List](uint64list-class) with the same length as the
`elements` list and copies over the elements.

[Uint64List.sublistView](uint64list/uint64list.sublistview)([TypedData](typeddata-class)
...
Creates a [Uint64List](uint64list-class) view on a range of elements of
`data`.

[Uint64List.view](uint64list/uint64list.view)([ByteBuffer](bytebuffer-class)
...
Creates an [Uint64List](uint64list-class) *view* of the specified region
...
[sublist](uint64list/sublist)([int](../dart-core/int-class) start,
\[[int](../dart-core/int-class)? end\]) → [Uint64List](uint64list-class)
...
[bytesPerElement](uint64list/bytesperelement-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Uint64List-class.html>
:::
