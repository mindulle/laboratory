...
Float32x4List.view constructor
==============================
...
Creates a [Float32x4List](../float32x4list-class) *view* of the
specified region in `buffer`.

Changes in the [Float32x4List](../float32x4list-class) will be visible
...
Merely doing `Float32x4List.view(other.buffer, 0, count)` may not point
...
Alternatively, use
[Float32x4List.sublistView](float32x4list.sublistview) which includes
this computation:
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Float32x4List/Float32x4List.view.html>
:::
