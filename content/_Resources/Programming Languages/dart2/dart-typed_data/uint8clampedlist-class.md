...
That is, all values below zero are stored as zero and all values above
255 are stored as 255.
...
[Uint8ClampedList](uint8clampedlist/uint8clampedlist)([int](../dart-core/int-class)
length)
...
[Uint8ClampedList.fromList](uint8clampedlist/uint8clampedlist.fromlist)([List](../dart-core/list-class)\<[int](../dart-core/int-class)\>
elements)
...
Creates a [Uint8ClampedList](uint8clampedlist-class) of the same size as
the `elements` list and copies over the values clamping when needed.

[Uint8ClampedList.sublistView](uint8clampedlist/uint8clampedlist.sublistview)([TypedData](typeddata-class)
...
Creates a [Uint8ClampedList](uint8clampedlist-class) view on a range of
elements of `data`.

[Uint8ClampedList.view](uint8clampedlist/uint8clampedlist.view)([ByteBuffer](bytebuffer-class)
...
[sublist](uint8clampedlist/sublist)([int](../dart-core/int-class) start,
\[[int](../dart-core/int-class)? end\]) →
...
[bytesPerElement](uint8clampedlist/bytesperelement-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Uint8ClampedList-class.html>
:::
