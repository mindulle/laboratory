...
Uint32List.sublistView constructor
==================================
...
Creates a [Uint32List](../uint32list-class) view on a range of elements
of `data`.
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Uint32List/Uint32List.sublistView.html>
:::
