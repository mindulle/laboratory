...
Creates an [Uint64List](../uint64list-class) *view* of the specified
region in the specified byte buffer.

Changes in the [Uint64List](../uint64list-class) will be visible in the
...
Merely doing `Uint64List.view(other.buffer, 0, count)` may not point to
...
Alternatively, use [Uint64List.sublistView](uint64list.sublistview)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Uint64List/Uint64List.view.html>
:::
