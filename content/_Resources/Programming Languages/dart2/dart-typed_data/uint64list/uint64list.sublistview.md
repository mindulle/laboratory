...
Uint64List.sublistView constructor
==================================
...
Creates a [Uint64List](../uint64list-class) view on a range of elements
of `data`.
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Uint64List/Uint64List.sublistView.html>
:::
