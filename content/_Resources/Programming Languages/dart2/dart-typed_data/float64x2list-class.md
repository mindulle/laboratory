...
[Float64x2List](float64x2list/float64x2list)([int](../dart-core/int-class)
length)
...
Creates a [Float64x2List](float64x2list-class) of the specified length
(in elements), all of whose elements have all lanes set to zero.

[Float64x2List.fromList](float64x2list/float64x2list.fromlist)([List](../dart-core/list-class)\<[Float64x2](float64x2-class)\>
elements)
...
Creates a [Float64x2List](float64x2list-class) with the same length as
the `elements` list and copies over the elements.

[Float64x2List.sublistView](float64x2list/float64x2list.sublistview)([TypedData](typeddata-class)
...
Creates an [Float64x2List](float64x2list-class) view on a range of
elements of `data`.

[Float64x2List.view](float64x2list/float64x2list.view)([ByteBuffer](bytebuffer-class)
...
Creates a [Float64x2List](float64x2list-class) *view* of the specified
region in `buffer`.
...
[first](../dart-core/iterable/first) ↔ [Float64x2](float64x2-class)
...
[last](../dart-core/iterable/last) ↔ [Float64x2](float64x2-class)
...
[single](../dart-core/iterable/single) → [Float64x2](float64x2-class)
...
[add](../dart-core/list/add)([Float64x2](float64x2-class) value) → void
...
[addAll](../dart-core/list/addall)([Iterable](../dart-core/iterable-class)\<[Float64x2](float64x2-class)\>
iterable) → void
...
toElements([Float64x2](float64x2-class) element)) →
...
previousValue, [Float64x2](float64x2-class) element)) → T
...
[followedBy](../dart-core/iterable/followedby)([Iterable](../dart-core/iterable-class)\<[Float64x2](float64x2-class)\>
other) →
[Iterable](../dart-core/iterable-class)\<[Float64x2](float64x2-class)\>
...
[indexOf](../dart-core/list/indexof)([Float64x2](float64x2-class)
...
[Float64x2](float64x2-class) element) → void
...
[lastIndexOf](../dart-core/list/lastindexof)([Float64x2](float64x2-class)
...
toElement([Float64x2](float64x2-class) e)) →
[Iterable](../dart-core/iterable-class)\<T\>
...
[reduce](../dart-core/iterable/reduce)([Float64x2](float64x2-class)
combine([Float64x2](float64x2-class) value, [Float64x2](float64x2-class)
element)) → [Float64x2](float64x2-class)
...
test([Float64x2](float64x2-class) value)) →
[Iterable](../dart-core/iterable-class)\<[Float64x2](float64x2-class)\>
...
compare([Float64x2](float64x2-class) a, [Float64x2](float64x2-class)
b)?\]) → void
...
[sublist](float64x2list/sublist)([int](../dart-core/int-class) start,
\[[int](../dart-core/int-class)? end\]) →
...
[operator
+](float64x2list/operator_plus)([List](../dart-core/list-class)\<[Float64x2](float64x2-class)\>
...
[bytesPerElement](float64x2list/bytesperelement-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Float64x2List-class.html>
:::
