...
[Int16List](int16list/int16list)([int](../dart-core/int-class) length)
...
[Int16List.fromList](int16list/int16list.fromlist)([List](../dart-core/list-class)\<[int](../dart-core/int-class)\>
elements)
...
[Int16List.sublistView](int16list/int16list.sublistview)([TypedData](typeddata-class)
...
Creates an [Int16List](int16list-class) view on a range of elements of
`data`.

[Int16List.view](int16list/int16list.view)([ByteBuffer](bytebuffer-class)
...
Creates an [Int16List](int16list-class) *view* of the specified region
in `buffer`.
...
[sublist](int16list/sublist)([int](../dart-core/int-class) start,
\[[int](../dart-core/int-class)? end\]) → [Int16List](int16list-class)
...
[bytesPerElement](int16list/bytesperelement-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Int16List-class.html>
:::
