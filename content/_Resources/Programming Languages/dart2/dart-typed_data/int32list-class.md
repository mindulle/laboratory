...
interpreted as a signed 32-bit two\'s complement integer with values in
...
[Int32List](int32list/int32list)([int](../dart-core/int-class) length)
...
[Int32List.fromList](int32list/int32list.fromlist)([List](../dart-core/list-class)\<[int](../dart-core/int-class)\>
elements)
...
[Int32List.sublistView](int32list/int32list.sublistview)([TypedData](typeddata-class)
...
Creates an [Int32List](int32list-class) view on a range of elements of
`data`.

[Int32List.view](int32list/int32list.view)([ByteBuffer](bytebuffer-class)
...
Creates an [Int32List](int32list-class) *view* of the specified region
in `buffer`.
...
[sublist](int32list/sublist)([int](../dart-core/int-class) start,
\[[int](../dart-core/int-class)? end\]) → [Int32List](int32list-class)
...
[bytesPerElement](int32list/bytesperelement-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-typed_data/Int32List-class.html>
:::
