...
[FEMorphologyElement.created](femorphologyelement/femorphologyelement.created)()
...
[height](femorphologyelement/height) →
...
[in1](femorphologyelement/in1) → [AnimatedString](animatedstring-class)?
...
[operator](femorphologyelement/operator) →
...
[radiusX](femorphologyelement/radiusx) →
...
[radiusY](femorphologyelement/radiusy) →
[AnimatedNumber](animatednumber-class)?
...
[result](femorphologyelement/result) →
...
[width](femorphologyelement/width) →
[AnimatedLength](animatedlength-class)?
...
[x](femorphologyelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](femorphologyelement/y) → [AnimatedLength](animatedlength-class)?
...
[SVG\_MORPHOLOGY\_OPERATOR\_DILATE](femorphologyelement/svg_morphology_operator_dilate-constant) → const [int](../dart-core/int-class)
...
[SVG\_MORPHOLOGY\_OPERATOR\_ERODE](femorphologyelement/svg_morphology_operator_erode-constant) → const [int](../dart-core/int-class)
...
[SVG\_MORPHOLOGY\_OPERATOR\_UNKNOWN](femorphologyelement/svg_morphology_operator_unknown-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEMorphologyElement-class.html>
:::
