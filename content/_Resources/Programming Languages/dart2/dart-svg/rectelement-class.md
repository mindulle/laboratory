...
[RectElement.created](rectelement/rectelement.created)()
...
[height](rectelement/height) → [AnimatedLength](animatedlength-class)?
...
[pathLength](geometryelement/pathlength) →
...
[rx](rectelement/rx) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[ry](rectelement/ry) → [AnimatedLength](animatedlength-class)?
...
[width](rectelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[x](rectelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y](rectelement/y) → [AnimatedLength](animatedlength-class)?
...
[getPointAtLength](geometryelement/getpointatlength)([num](../dart-core/num-class)
distance) → [Point](point-class)
...
[getTotalLength](geometryelement/gettotallength)() →
...
[isPointInFill](geometryelement/ispointinfill)([Point](point-class)
point) → [bool](../dart-core/bool-class)

::: {.features}
inherited
:::

[isPointInStroke](geometryelement/ispointinstroke)([Point](point-class)
point) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/RectElement-class.html>
:::
