...
[ForeignObjectElement](foreignobjectelement/foreignobjectelement)()

::: {.constructor-modifier .features}
factory
:::

[ForeignObjectElement.created](foreignobjectelement/foreignobjectelement.created)()
...
[height](foreignobjectelement/height) →
...
[width](foreignobjectelement/width) →
[AnimatedLength](animatedlength-class)?
...
[x](foreignobjectelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y](foreignobjectelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](foreignobjectelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/ForeignObjectElement-class.html>
:::
