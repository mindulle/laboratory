...
:   -   [List](../dart-core/list-class)\<[Length](length-class)\>

Mixed in types

:   -   [ListMixin](../dart-collection/listmixin-class)\<[Length](length-class)\>
    -   [ImmutableListMixin](../dart-html/immutablelistmixin-class)\<[Length](length-class)\>
...
[first](lengthlist/first) ↔ [Length](length-class)
...
[Iterator](../dart-core/iterator-class)\<[Length](length-class)\>
...
[last](lengthlist/last) ↔ [Length](length-class)
...
[length](lengthlist/length) ↔ [int](../dart-core/int-class)
...
[numberOfItems](lengthlist/numberofitems) →
...
[Iterable](../dart-core/iterable-class)\<[Length](length-class)\>
...
[single](lengthlist/single) → [Length](length-class)
...
[add](../dart-html/immutablelistmixin/add)([Length](length-class) value)
→ void
...
[addAll](../dart-html/immutablelistmixin/addall)([Iterable](../dart-core/iterable-class)\<[Length](length-class)\>
iterable) → void
...
test([Length](length-class) element)) → [bool](../dart-core/bool-class)
...
[appendItem](lengthlist/appenditem)([Length](length-class) newItem) →
[Length](length-class)
...
[elementAt](lengthlist/elementat)([int](../dart-core/int-class) index) →
[Length](length-class)
...
start, [int](../dart-core/int-class) end, \[[Length](length-class)?
fillValue\]) → void
...
test([Length](length-class) element), {[Length](length-class)
orElse()?}) → [Length](length-class)
...
combine(T previousValue, [Length](length-class) element)) → T
...
[followedBy](../dart-collection/listmixin/followedby)([Iterable](../dart-core/iterable-class)\<[Length](length-class)\>
other) →
[Iterable](../dart-core/iterable-class)\<[Length](length-class)\>
...
action([Length](length-class) element)) → void
...
[getItem](lengthlist/getitem)([int](../dart-core/int-class) index) →
[Length](length-class)
...
test([Length](length-class) element), \[[int](../dart-core/int-class)
...
[initialize](lengthlist/initialize)([Length](length-class) newItem) →
[Length](length-class)

[insert](../dart-html/immutablelistmixin/insert)([int](../dart-core/int-class)
index, [Length](length-class) element) → void
...
index, [Iterable](../dart-core/iterable-class)\<[Length](length-class)\>
iterable) → void
...
[insertItemBefore](lengthlist/insertitembefore)([Length](length-class)
newItem, [int](../dart-core/int-class) index) → [Length](length-class)
...
[map](../dart-collection/listmixin/map)\<T\>(T f([Length](length-class)
...
[reduce](../dart-collection/listmixin/reduce)([Length](length-class)
combine([Length](length-class) previousValue, [Length](length-class)
element)) → [Length](length-class)
...
[removeItem](lengthlist/removeitem)([int](../dart-core/int-class) index)
→ [Length](length-class)
...
test([Length](length-class) element)) → void
...
[replaceItem](lengthlist/replaceitem)([Length](length-class) newItem,
[int](../dart-core/int-class) index) → [Length](length-class)
...
test([Length](length-class) element)) →
[Iterable](../dart-core/iterable-class)\<[Length](length-class)\>
...
compare([Length](length-class) a, [Length](length-class) b)?\]) → void
...
[Set](../dart-core/set-class)\<[Length](length-class)\>
...
[operator
+](../dart-collection/listmixin/operator_plus)([List](../dart-core/list-class)\<[Length](length-class)\>
other) → [List](../dart-core/list-class)\<[Length](length-class)\>
...
[operator \[\]](lengthlist/operator_get)([int](../dart-core/int-class)
index) → [Length](length-class)
...
[operator \[\]=](lengthlist/operator_put)([int](../dart-core/int-class)
index, [Length](length-class) value) → void
...
<https://api.dart.dev/stable/2.18.5/dart-svg/LengthList-class.html>
:::
