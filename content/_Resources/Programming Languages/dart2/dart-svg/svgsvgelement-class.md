...
[SvgSvgElement](svgsvgelement/svgsvgelement)()

::: {.constructor-modifier .features}
factory
:::

[SvgSvgElement.created](svgsvgelement/svgsvgelement.created)()
...
[currentScale](svgsvgelement/currentscale) ↔
...
[currentTranslate](svgsvgelement/currenttranslate) →
[Point](point-class)?
...
[height](svgsvgelement/height) → [AnimatedLength](animatedlength-class)?
...
[preserveAspectRatio](svgsvgelement/preserveaspectratio) →
...
[viewBox](svgsvgelement/viewbox) → [AnimatedRect](animatedrect-class)?
...
[width](svgsvgelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[x](svgsvgelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y](svgsvgelement/y) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[zoomAndPan](svgsvgelement/zoomandpan) ↔ [int](../dart-core/int-class)?
...
[animationsPaused](svgsvgelement/animationspaused)() →
[bool](../dart-core/bool-class)
...
[checkEnclosure](svgsvgelement/checkenclosure)([SvgElement](svgelement-class)
element, [Rect](rect-class) rect) → [bool](../dart-core/bool-class)

[checkIntersection](svgsvgelement/checkintersection)([SvgElement](svgelement-class)
element, [Rect](rect-class) rect) → [bool](../dart-core/bool-class)
...
[createSvgAngle](svgsvgelement/createsvgangle)() → [Angle](angle-class)

::: {.features}
\@JSName(\'createSVGAngle\')
:::

[createSvgLength](svgsvgelement/createsvglength)() →
[Length](length-class)
...
[createSvgMatrix](svgsvgelement/createsvgmatrix)() →
[Matrix](matrix-class)
...
[createSvgNumber](svgsvgelement/createsvgnumber)() →
[Number](number-class)
...
[createSvgPoint](svgsvgelement/createsvgpoint)() → [Point](point-class)

::: {.features}
\@JSName(\'createSVGPoint\')
:::

[createSvgRect](svgsvgelement/createsvgrect)() → [Rect](rect-class)

::: {.features}
\@JSName(\'createSVGRect\')
:::

[createSvgTransform](svgsvgelement/createsvgtransform)() →
...
[createSvgTransformFromMatrix](svgsvgelement/createsvgtransformfrommatrix)([Matrix](matrix-class)
...
[deselectAll](svgsvgelement/deselectall)() → void
...
[forceRedraw](svgsvgelement/forceredraw)() → void
...
[getCurrentTime](svgsvgelement/getcurrenttime)() →
...
[getElementById](svgsvgelement/getelementbyid)([String](../dart-core/string-class)
elementId) → [Element](../dart-html/element-class)
...
[getEnclosureList](svgsvgelement/getenclosurelist)([Rect](rect-class)
rect, [SvgElement](svgelement-class)? referenceElement) →
[List](../dart-core/list-class)\<[Node](../dart-html/node-class)\>
...
[getIntersectionList](svgsvgelement/getintersectionlist)([Rect](rect-class)
rect, [SvgElement](svgelement-class)? referenceElement) →
[List](../dart-core/list-class)\<[Node](../dart-html/node-class)\>
...
[pauseAnimations](svgsvgelement/pauseanimations)() → void
...
[setCurrentTime](svgsvgelement/setcurrenttime)([num](../dart-core/num-class)
seconds) → void
...
[suspendRedraw](svgsvgelement/suspendredraw)([int](../dart-core/int-class)
maxWaitMilliseconds) → [int](../dart-core/int-class)
...
[unpauseAnimations](svgsvgelement/unpauseanimations)() → void

[unsuspendRedraw](svgsvgelement/unsuspendredraw)([int](../dart-core/int-class)
suspendHandleId) → void

[unsuspendRedrawAll](svgsvgelement/unsuspendredrawall)() → void
...
<https://api.dart.dev/stable/2.18.5/dart-svg/SvgSvgElement-class.html>
:::
