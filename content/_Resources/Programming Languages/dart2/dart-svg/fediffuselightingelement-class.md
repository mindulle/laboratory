...
FEDiffuseLightingElement class
==============================
...
[FEDiffuseLightingElement](fediffuselightingelement/fediffuselightingelement)()

::: {.constructor-modifier .features}
factory
:::

[FEDiffuseLightingElement.created](fediffuselightingelement/fediffuselightingelement.created)()
...
[diffuseConstant](fediffuselightingelement/diffuseconstant) →
...
[height](fediffuselightingelement/height) →
...
[in1](fediffuselightingelement/in1) →
...
[kernelUnitLengthX](fediffuselightingelement/kernelunitlengthx) →
[AnimatedNumber](animatednumber-class)?
...
[kernelUnitLengthY](fediffuselightingelement/kernelunitlengthy) →
[AnimatedNumber](animatednumber-class)?
...
[result](fediffuselightingelement/result) →
[AnimatedString](animatedstring-class)?
...
[surfaceScale](fediffuselightingelement/surfacescale) →
[AnimatedNumber](animatednumber-class)?
...
[width](fediffuselightingelement/width) →
[AnimatedLength](animatedlength-class)?
...
[supported](fediffuselightingelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEDiffuseLightingElement-class.html>
:::
