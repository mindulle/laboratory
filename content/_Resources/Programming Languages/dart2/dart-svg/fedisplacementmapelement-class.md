...
FEDisplacementMapElement class
==============================
...
[FEDisplacementMapElement](fedisplacementmapelement/fedisplacementmapelement)()

::: {.constructor-modifier .features}
factory
:::

[FEDisplacementMapElement.created](fedisplacementmapelement/fedisplacementmapelement.created)()
...
[height](fedisplacementmapelement/height) →
...
[in1](fedisplacementmapelement/in1) →
...
[in2](fedisplacementmapelement/in2) →
[AnimatedString](animatedstring-class)?
...
[result](fedisplacementmapelement/result) →
[AnimatedString](animatedstring-class)?
...
[scale](fedisplacementmapelement/scale) →
...
[width](fedisplacementmapelement/width) →
[AnimatedLength](animatedlength-class)?
...
[xChannelSelector](fedisplacementmapelement/xchannelselector) →
...
[yChannelSelector](fedisplacementmapelement/ychannelselector) →
[AnimatedEnumeration](animatedenumeration-class)?
...
[supported](fedisplacementmapelement/supported) →
[bool](../dart-core/bool-class)
...
[SVG\_CHANNEL\_A](fedisplacementmapelement/svg_channel_a-constant) → const [int](../dart-core/int-class)
...
[SVG\_CHANNEL\_B](fedisplacementmapelement/svg_channel_b-constant) → const [int](../dart-core/int-class)
...
[SVG\_CHANNEL\_G](fedisplacementmapelement/svg_channel_g-constant) → const [int](../dart-core/int-class)
...
[SVG\_CHANNEL\_R](fedisplacementmapelement/svg_channel_r-constant) → const [int](../dart-core/int-class)
...
[SVG\_CHANNEL\_UNKNOWN](fedisplacementmapelement/svg_channel_unknown-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEDisplacementMapElement-class.html>
:::
