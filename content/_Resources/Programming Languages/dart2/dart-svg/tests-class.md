...
[requiredExtensions](tests/requiredextensions) →
...
[systemLanguage](tests/systemlanguage) → [StringList](stringlist-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/Tests-class.html>
:::
