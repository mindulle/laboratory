...
FESpecularLightingElement class
===============================
...
[FESpecularLightingElement](fespecularlightingelement/fespecularlightingelement)()

::: {.constructor-modifier .features}
factory
:::

[FESpecularLightingElement.created](fespecularlightingelement/fespecularlightingelement.created)()
...
[height](fespecularlightingelement/height) →
...
[in1](fespecularlightingelement/in1) →
...
[kernelUnitLengthX](fespecularlightingelement/kernelunitlengthx) →
...
[kernelUnitLengthY](fespecularlightingelement/kernelunitlengthy) →
[AnimatedNumber](animatednumber-class)?
...
[result](fespecularlightingelement/result) →
[AnimatedString](animatedstring-class)?
...
[specularConstant](fespecularlightingelement/specularconstant) →
[AnimatedNumber](animatednumber-class)?
...
[specularExponent](fespecularlightingelement/specularexponent) →
[AnimatedNumber](animatednumber-class)?
...
[surfaceScale](fespecularlightingelement/surfacescale) →
[AnimatedNumber](animatednumber-class)?
...
[width](fespecularlightingelement/width) →
[AnimatedLength](animatedlength-class)?
...
[supported](fespecularlightingelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FESpecularLightingElement-class.html>
:::
