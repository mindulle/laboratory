...
[FETurbulenceElement](feturbulenceelement/feturbulenceelement)()

::: {.constructor-modifier .features}
factory
:::

[FETurbulenceElement.created](feturbulenceelement/feturbulenceelement.created)()
...
[baseFrequencyX](feturbulenceelement/basefrequencyx) →
...
[baseFrequencyY](feturbulenceelement/basefrequencyy) →
[AnimatedNumber](animatednumber-class)?
...
[height](feturbulenceelement/height) →
...
[numOctaves](feturbulenceelement/numoctaves) →
...
[result](feturbulenceelement/result) →
...
[stitchTiles](feturbulenceelement/stitchtiles) →
...
[width](feturbulenceelement/width) →
[AnimatedLength](animatedlength-class)?
...
[x](feturbulenceelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](feturbulenceelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](feturbulenceelement/supported) →
[bool](../dart-core/bool-class)
...
[SVG\_STITCHTYPE\_NOSTITCH](feturbulenceelement/svg_stitchtype_nostitch-constant) → const [int](../dart-core/int-class)
...
[SVG\_STITCHTYPE\_STITCH](feturbulenceelement/svg_stitchtype_stitch-constant) → const [int](../dart-core/int-class)
...
[SVG\_STITCHTYPE\_UNKNOWN](feturbulenceelement/svg_stitchtype_unknown-constant) → const [int](../dart-core/int-class)
...
[SVG\_TURBULENCE\_TYPE\_FRACTALNOISE](feturbulenceelement/svg_turbulence_type_fractalnoise-constant) → const [int](../dart-core/int-class)
...
[SVG\_TURBULENCE\_TYPE\_TURBULENCE](feturbulenceelement/svg_turbulence_type_turbulence-constant) → const [int](../dart-core/int-class)
...
[SVG\_TURBULENCE\_TYPE\_UNKNOWN](feturbulenceelement/svg_turbulence_type_unknown-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FETurbulenceElement-class.html>
:::
