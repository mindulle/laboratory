...
[ViewElement](viewelement/viewelement)()

::: {.constructor-modifier .features}
factory
:::

[ViewElement.created](viewelement/viewelement.created)()
...
[preserveAspectRatio](viewelement/preserveaspectratio) →
...
[viewBox](viewelement/viewbox) → [AnimatedRect](animatedrect-class)?
...
[zoomAndPan](viewelement/zoomandpan) ↔ [int](../dart-core/int-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/ViewElement-class.html>
:::
