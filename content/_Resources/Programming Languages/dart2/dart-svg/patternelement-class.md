...
[PatternElement.created](patternelement/patternelement.created)()
...
[href](patternelement/href) → [AnimatedString](animatedstring-class)?
...
[patternContentUnits](patternelement/patterncontentunits) →
...
[patternTransform](patternelement/patterntransform) →
...
[requiredExtensions](patternelement/requiredextensions) →
...
[systemLanguage](patternelement/systemlanguage) →
[StringList](stringlist-class)?
...
[viewBox](patternelement/viewbox) → [AnimatedRect](animatedrect-class)?
...
[width](patternelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[x](patternelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y](patternelement/y) → [AnimatedLength](animatedlength-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/PatternElement-class.html>
:::
