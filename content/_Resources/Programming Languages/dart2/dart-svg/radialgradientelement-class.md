...
[RadialGradientElement](radialgradientelement/radialgradientelement)()

::: {.constructor-modifier .features}
factory
:::

[RadialGradientElement.created](radialgradientelement/radialgradientelement.created)()
...
[cx](radialgradientelement/cx) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[cy](radialgradientelement/cy) → [AnimatedLength](animatedlength-class)?
...
[fr](radialgradientelement/fr) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[fx](radialgradientelement/fx) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[fy](radialgradientelement/fy) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[gradientTransform](radialgradientelement/gradienttransform) →
...
[gradientUnits](radialgradientelement/gradientunits) →
...
[href](radialgradientelement/href) →
...
[r](radialgradientelement/r) → [AnimatedLength](animatedlength-class)?
...
[spreadMethod](radialgradientelement/spreadmethod) →
[AnimatedEnumeration](animatedenumeration-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/RadialGradientElement-class.html>
:::
