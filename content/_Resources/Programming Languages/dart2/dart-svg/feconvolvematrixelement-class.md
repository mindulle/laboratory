...
[FEConvolveMatrixElement](feconvolvematrixelement/feconvolvematrixelement)()

::: {.constructor-modifier .features}
factory
:::

[FEConvolveMatrixElement.created](feconvolvematrixelement/feconvolvematrixelement.created)()
...
[bias](feconvolvematrixelement/bias) →
...
[divisor](feconvolvematrixelement/divisor) →
[AnimatedNumber](animatednumber-class)?
...
[edgeMode](feconvolvematrixelement/edgemode) →
...
[height](feconvolvematrixelement/height) →
...
[in1](feconvolvematrixelement/in1) →
...
[kernelMatrix](feconvolvematrixelement/kernelmatrix) →
...
[kernelUnitLengthX](feconvolvematrixelement/kernelunitlengthx) →
[AnimatedNumber](animatednumber-class)?
...
[kernelUnitLengthY](feconvolvematrixelement/kernelunitlengthy) →
[AnimatedNumber](animatednumber-class)?
...
[orderX](feconvolvematrixelement/orderx) →
...
[orderY](feconvolvematrixelement/ordery) →
[AnimatedInteger](animatedinteger-class)?
...
[preserveAlpha](feconvolvematrixelement/preservealpha) →
...
[result](feconvolvematrixelement/result) →
[AnimatedString](animatedstring-class)?
...
[targetX](feconvolvematrixelement/targetx) →
[AnimatedInteger](animatedinteger-class)?
...
[targetY](feconvolvematrixelement/targety) →
[AnimatedInteger](animatedinteger-class)?
...
[width](feconvolvematrixelement/width) →
[AnimatedLength](animatedlength-class)?
...
[x](feconvolvematrixelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](feconvolvematrixelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](feconvolvematrixelement/supported) →
[bool](../dart-core/bool-class)
...
[SVG\_EDGEMODE\_DUPLICATE](feconvolvematrixelement/svg_edgemode_duplicate-constant) → const [int](../dart-core/int-class)
...
[SVG\_EDGEMODE\_NONE](feconvolvematrixelement/svg_edgemode_none-constant) → const [int](../dart-core/int-class)
...
[SVG\_EDGEMODE\_UNKNOWN](feconvolvematrixelement/svg_edgemode_unknown-constant) → const [int](../dart-core/int-class)
...
[SVG\_EDGEMODE\_WRAP](feconvolvematrixelement/svg_edgemode_wrap-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEConvolveMatrixElement-class.html>
:::
