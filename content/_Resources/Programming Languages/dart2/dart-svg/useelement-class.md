...
[UseElement.created](useelement/useelement.created)()
...
[height](useelement/height) → [AnimatedLength](animatedlength-class)?
...
[href](useelement/href) → [AnimatedString](animatedstring-class)?
...
[width](useelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[x](useelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y](useelement/y) → [AnimatedLength](animatedlength-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/UseElement-class.html>
:::
