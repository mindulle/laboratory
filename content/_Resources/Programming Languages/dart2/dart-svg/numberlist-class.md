...
:   -   [List](../dart-core/list-class)\<[Number](number-class)\>

Mixed in types

:   -   [ListMixin](../dart-collection/listmixin-class)\<[Number](number-class)\>
    -   [ImmutableListMixin](../dart-html/immutablelistmixin-class)\<[Number](number-class)\>
...
[first](numberlist/first) ↔ [Number](number-class)
...
[Iterator](../dart-core/iterator-class)\<[Number](number-class)\>
...
[last](numberlist/last) ↔ [Number](number-class)
...
[length](numberlist/length) ↔ [int](../dart-core/int-class)
...
[numberOfItems](numberlist/numberofitems) →
...
[Iterable](../dart-core/iterable-class)\<[Number](number-class)\>
...
[single](numberlist/single) → [Number](number-class)
...
[add](../dart-html/immutablelistmixin/add)([Number](number-class) value)
→ void
...
[addAll](../dart-html/immutablelistmixin/addall)([Iterable](../dart-core/iterable-class)\<[Number](number-class)\>
iterable) → void
...
test([Number](number-class) element)) → [bool](../dart-core/bool-class)
...
[appendItem](numberlist/appenditem)([Number](number-class) newItem) →
[Number](number-class)
...
[elementAt](numberlist/elementat)([int](../dart-core/int-class) index) →
[Number](number-class)
...
start, [int](../dart-core/int-class) end, \[[Number](number-class)?
fillValue\]) → void
...
test([Number](number-class) element), {[Number](number-class)
orElse()?}) → [Number](number-class)
...
combine(T previousValue, [Number](number-class) element)) → T
...
[followedBy](../dart-collection/listmixin/followedby)([Iterable](../dart-core/iterable-class)\<[Number](number-class)\>
other) →
[Iterable](../dart-core/iterable-class)\<[Number](number-class)\>
...
action([Number](number-class) element)) → void
...
[getItem](numberlist/getitem)([int](../dart-core/int-class) index) →
[Number](number-class)
...
test([Number](number-class) element), \[[int](../dart-core/int-class)
...
[initialize](numberlist/initialize)([Number](number-class) newItem) →
[Number](number-class)

[insert](../dart-html/immutablelistmixin/insert)([int](../dart-core/int-class)
index, [Number](number-class) element) → void
...
index, [Iterable](../dart-core/iterable-class)\<[Number](number-class)\>
iterable) → void
...
[insertItemBefore](numberlist/insertitembefore)([Number](number-class)
newItem, [int](../dart-core/int-class) index) → [Number](number-class)
...
[map](../dart-collection/listmixin/map)\<T\>(T f([Number](number-class)
...
[reduce](../dart-collection/listmixin/reduce)([Number](number-class)
combine([Number](number-class) previousValue, [Number](number-class)
element)) → [Number](number-class)
...
[removeItem](numberlist/removeitem)([int](../dart-core/int-class) index)
→ [Number](number-class)
...
test([Number](number-class) element)) → void
...
[replaceItem](numberlist/replaceitem)([Number](number-class) newItem,
[int](../dart-core/int-class) index) → [Number](number-class)
...
test([Number](number-class) element)) →
[Iterable](../dart-core/iterable-class)\<[Number](number-class)\>
...
compare([Number](number-class) a, [Number](number-class) b)?\]) → void
...
[Set](../dart-core/set-class)\<[Number](number-class)\>
...
[operator
+](../dart-collection/listmixin/operator_plus)([List](../dart-core/list-class)\<[Number](number-class)\>
other) → [List](../dart-core/list-class)\<[Number](number-class)\>
...
[operator \[\]](numberlist/operator_get)([int](../dart-core/int-class)
index) → [Number](number-class)
...
[operator \[\]=](numberlist/operator_put)([int](../dart-core/int-class)
index, [Number](number-class) value) → void
...
<https://api.dart.dev/stable/2.18.5/dart-svg/NumberList-class.html>
:::
