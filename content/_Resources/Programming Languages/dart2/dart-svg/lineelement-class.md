...
[LineElement.created](lineelement/lineelement.created)()
...
[x1](lineelement/x1) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[x2](lineelement/x2) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y1](lineelement/y1) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y2](lineelement/y2) → [AnimatedLength](animatedlength-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/LineElement-class.html>
:::
