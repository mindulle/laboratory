...
[FEPointLightElement](fepointlightelement/fepointlightelement)()

::: {.constructor-modifier .features}
factory
:::

[FEPointLightElement.created](fepointlightelement/fepointlightelement.created)()
...
[x](fepointlightelement/x) → [AnimatedNumber](animatednumber-class)?

::: {.features}
read-only
:::

[y](fepointlightelement/y) → [AnimatedNumber](animatednumber-class)?

::: {.features}
read-only
:::

[z](fepointlightelement/z) → [AnimatedNumber](animatednumber-class)?
...
[supported](fepointlightelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEPointLightElement-class.html>
:::
