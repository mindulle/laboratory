...
[TextPathElement.created](textpathelement/textpathelement.created)()
...
[href](textpathelement/href) → [AnimatedString](animatedstring-class)?
...
[spacing](textpathelement/spacing) →
[AnimatedEnumeration](animatedenumeration-class)?
...
[startOffset](textpathelement/startoffset) →
...
[textLength](textcontentelement/textlength) →
[AnimatedLength](animatedlength-class)?
...
[getCharNumAtPosition](textcontentelement/getcharnumatposition)([Point](point-class)
point) → [int](../dart-core/int-class)
...
[getComputedTextLength](textcontentelement/getcomputedtextlength)() →
...
[getEndPositionOfChar](textcontentelement/getendpositionofchar)([int](../dart-core/int-class)
charnum) → [Point](point-class)

::: {.features}
inherited
:::

[getExtentOfChar](textcontentelement/getextentofchar)([int](../dart-core/int-class)
charnum) → [Rect](rect-class)
...
[getNumberOfChars](textcontentelement/getnumberofchars)() →
[int](../dart-core/int-class)
...
[getRotationOfChar](textcontentelement/getrotationofchar)([int](../dart-core/int-class)
charnum) → [double](../dart-core/double-class)
...
[getStartPositionOfChar](textcontentelement/getstartpositionofchar)([int](../dart-core/int-class)
charnum) → [Point](point-class)
...
[getSubStringLength](textcontentelement/getsubstringlength)([int](../dart-core/int-class)
charnum, [int](../dart-core/int-class) nchars) →
[double](../dart-core/double-class)
...
[selectSubString](textcontentelement/selectsubstring)([int](../dart-core/int-class)
charnum, [int](../dart-core/int-class) nchars) → void
...
[TEXTPATH\_METHODTYPE\_ALIGN](textpathelement/textpath_methodtype_align-constant) → const [int](../dart-core/int-class)
...
[TEXTPATH\_METHODTYPE\_STRETCH](textpathelement/textpath_methodtype_stretch-constant) → const [int](../dart-core/int-class)
...
[TEXTPATH\_METHODTYPE\_UNKNOWN](textpathelement/textpath_methodtype_unknown-constant) → const [int](../dart-core/int-class)
...
[TEXTPATH\_SPACINGTYPE\_AUTO](textpathelement/textpath_spacingtype_auto-constant) → const [int](../dart-core/int-class)
...
[TEXTPATH\_SPACINGTYPE\_EXACT](textpathelement/textpath_spacingtype_exact-constant) → const [int](../dart-core/int-class)
...
[TEXTPATH\_SPACINGTYPE\_UNKNOWN](textpathelement/textpath_spacingtype_unknown-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/TextPathElement-class.html>
:::
