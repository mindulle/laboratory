...
[FEGaussianBlurElement](fegaussianblurelement/fegaussianblurelement)()

::: {.constructor-modifier .features}
factory
:::

[FEGaussianBlurElement.created](fegaussianblurelement/fegaussianblurelement.created)()
...
[height](fegaussianblurelement/height) →
...
[result](fegaussianblurelement/result) →
[AnimatedString](animatedstring-class)?
...
[stdDeviationX](fegaussianblurelement/stddeviationx) →
...
[stdDeviationY](fegaussianblurelement/stddeviationy) →
[AnimatedNumber](animatednumber-class)?
...
[width](fegaussianblurelement/width) →
[AnimatedLength](animatedlength-class)?
...
[x](fegaussianblurelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](fegaussianblurelement/y) → [AnimatedLength](animatedlength-class)?
...
[setStdDeviation](fegaussianblurelement/setstddeviation)([num](../dart-core/num-class)
stdDeviationX, [num](../dart-core/num-class) stdDeviationY) → void
...
[supported](fegaussianblurelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEGaussianBlurElement-class.html>
:::
