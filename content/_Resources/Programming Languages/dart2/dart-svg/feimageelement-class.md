...
[FEImageElement](feimageelement/feimageelement)()

::: {.constructor-modifier .features}
factory
:::

[FEImageElement.created](feimageelement/feimageelement.created)()
...
[href](feimageelement/href) → [AnimatedString](animatedstring-class)?
...
[preserveAspectRatio](feimageelement/preserveaspectratio) →
...
[width](feimageelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[x](feimageelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](feimageelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](feimageelement/supported) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEImageElement-class.html>
:::
