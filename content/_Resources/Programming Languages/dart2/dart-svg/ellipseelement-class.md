...
[EllipseElement](ellipseelement/ellipseelement)()

::: {.constructor-modifier .features}
factory
:::

[EllipseElement.created](ellipseelement/ellipseelement.created)()
...
[cx](ellipseelement/cx) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[cy](ellipseelement/cy) → [AnimatedLength](animatedlength-class)?
...
[rx](ellipseelement/rx) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[ry](ellipseelement/ry) → [AnimatedLength](animatedlength-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/EllipseElement-class.html>
:::
