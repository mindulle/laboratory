...
[FECompositeElement.created](fecompositeelement/fecompositeelement.created)()
...
[height](fecompositeelement/height) →
...
[in1](fecompositeelement/in1) → [AnimatedString](animatedstring-class)?

::: {.features}
read-only
:::

[in2](fecompositeelement/in2) → [AnimatedString](animatedstring-class)?
...
[k1](fecompositeelement/k1) → [AnimatedNumber](animatednumber-class)?

::: {.features}
read-only
:::

[k2](fecompositeelement/k2) → [AnimatedNumber](animatednumber-class)?

::: {.features}
read-only
:::

[k3](fecompositeelement/k3) → [AnimatedNumber](animatednumber-class)?

::: {.features}
read-only
:::

[k4](fecompositeelement/k4) → [AnimatedNumber](animatednumber-class)?
...
[operator](fecompositeelement/operator) →
...
[result](fecompositeelement/result) →
...
[width](fecompositeelement/width) →
[AnimatedLength](animatedlength-class)?
...
[x](fecompositeelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](fecompositeelement/y) → [AnimatedLength](animatedlength-class)?
...
[SVG\_FECOMPOSITE\_OPERATOR\_ARITHMETIC](fecompositeelement/svg_fecomposite_operator_arithmetic-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOMPOSITE\_OPERATOR\_ATOP](fecompositeelement/svg_fecomposite_operator_atop-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOMPOSITE\_OPERATOR\_IN](fecompositeelement/svg_fecomposite_operator_in-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOMPOSITE\_OPERATOR\_OUT](fecompositeelement/svg_fecomposite_operator_out-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOMPOSITE\_OPERATOR\_OVER](fecompositeelement/svg_fecomposite_operator_over-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOMPOSITE\_OPERATOR\_UNKNOWN](fecompositeelement/svg_fecomposite_operator_unknown-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOMPOSITE\_OPERATOR\_XOR](fecompositeelement/svg_fecomposite_operator_xor-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FECompositeElement-class.html>
:::
