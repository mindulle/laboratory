...
[MarkerElement](markerelement/markerelement)()

::: {.constructor-modifier .features}
factory
:::

[MarkerElement.created](markerelement/markerelement.created)()
...
[markerHeight](markerelement/markerheight) →
...
[markerUnits](markerelement/markerunits) →
...
[markerWidth](markerelement/markerwidth) →
[AnimatedLength](animatedlength-class)
...
[orientAngle](markerelement/orientangle) →
...
[orientType](markerelement/orienttype) →
[AnimatedEnumeration](animatedenumeration-class)?
...
[preserveAspectRatio](markerelement/preserveaspectratio) →
...
[refX](markerelement/refx) → [AnimatedLength](animatedlength-class)

::: {.features}
read-only
:::

[refY](markerelement/refy) → [AnimatedLength](animatedlength-class)
...
[viewBox](markerelement/viewbox) → [AnimatedRect](animatedrect-class)?
...
[setOrientToAngle](markerelement/setorienttoangle)([Angle](angle-class)
angle) → void

[setOrientToAuto](markerelement/setorienttoauto)() → void
...
[SVG\_MARKER\_ORIENT\_ANGLE](markerelement/svg_marker_orient_angle-constant) → const [int](../dart-core/int-class)
...
[SVG\_MARKER\_ORIENT\_AUTO](markerelement/svg_marker_orient_auto-constant) → const [int](../dart-core/int-class)
...
[SVG\_MARKER\_ORIENT\_UNKNOWN](markerelement/svg_marker_orient_unknown-constant) → const [int](../dart-core/int-class)
...
[SVG\_MARKERUNITS\_STROKEWIDTH](markerelement/svg_markerunits_strokewidth-constant) → const [int](../dart-core/int-class)
...
[SVG\_MARKERUNITS\_UNKNOWN](markerelement/svg_markerunits_unknown-constant) → const [int](../dart-core/int-class)
...
[SVG\_MARKERUNITS\_USERSPACEONUSE](markerelement/svg_markerunits_userspaceonuse-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/MarkerElement-class.html>
:::
