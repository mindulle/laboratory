...
[FilterElement.created](filterelement/filterelement.created)()
...
[filterUnits](filterelement/filterunits) →
...
[height](filterelement/height) → [AnimatedLength](animatedlength-class)?
...
[href](filterelement/href) → [AnimatedString](animatedstring-class)?
...
[primitiveUnits](filterelement/primitiveunits) →
[AnimatedEnumeration](animatedenumeration-class)?
...
[width](filterelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[x](filterelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y](filterelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](filterelement/supported) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FilterElement-class.html>
:::
