...
[MaskElement](maskelement/maskelement)()

::: {.constructor-modifier .features}
factory
:::

[MaskElement.created](maskelement/maskelement.created)()
...
[height](maskelement/height) → [AnimatedLength](animatedlength-class)?
...
[maskContentUnits](maskelement/maskcontentunits) →
...
[maskUnits](maskelement/maskunits) →
[AnimatedEnumeration](animatedenumeration-class)?
...
[requiredExtensions](maskelement/requiredextensions) →
...
[systemLanguage](maskelement/systemlanguage) →
[StringList](stringlist-class)?
...
[width](maskelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[x](maskelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y](maskelement/y) → [AnimatedLength](animatedlength-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/MaskElement-class.html>
:::
