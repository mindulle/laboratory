...
[FEColorMatrixElement](fecolormatrixelement/fecolormatrixelement)()

::: {.constructor-modifier .features}
factory
:::

[FEColorMatrixElement.created](fecolormatrixelement/fecolormatrixelement.created)()
...
[height](fecolormatrixelement/height) →
...
[in1](fecolormatrixelement/in1) → [AnimatedString](animatedstring-class)
...
[result](fecolormatrixelement/result) →
...
[type](fecolormatrixelement/type) →
...
[values](fecolormatrixelement/values) →
...
[width](fecolormatrixelement/width) →
[AnimatedLength](animatedlength-class)?
...
[x](fecolormatrixelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](fecolormatrixelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](fecolormatrixelement/supported) →
[bool](../dart-core/bool-class)
...
[SVG\_FECOLORMATRIX\_TYPE\_HUEROTATE](fecolormatrixelement/svg_fecolormatrix_type_huerotate-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOLORMATRIX\_TYPE\_LUMINANCETOALPHA](fecolormatrixelement/svg_fecolormatrix_type_luminancetoalpha-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOLORMATRIX\_TYPE\_MATRIX](fecolormatrixelement/svg_fecolormatrix_type_matrix-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOLORMATRIX\_TYPE\_SATURATE](fecolormatrixelement/svg_fecolormatrix_type_saturate-constant) → const [int](../dart-core/int-class)
...
[SVG\_FECOLORMATRIX\_TYPE\_UNKNOWN](fecolormatrixelement/svg_fecolormatrix_type_unknown-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEColorMatrixElement-class.html>
:::
