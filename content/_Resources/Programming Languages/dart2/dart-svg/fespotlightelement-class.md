...
[FESpotLightElement](fespotlightelement/fespotlightelement)()

::: {.constructor-modifier .features}
factory
:::

[FESpotLightElement.created](fespotlightelement/fespotlightelement.created)()
...
[limitingConeAngle](fespotlightelement/limitingconeangle) →
...
[pointsAtX](fespotlightelement/pointsatx) →
[AnimatedNumber](animatednumber-class)?
...
[pointsAtY](fespotlightelement/pointsaty) →
[AnimatedNumber](animatednumber-class)?
...
[pointsAtZ](fespotlightelement/pointsatz) →
[AnimatedNumber](animatednumber-class)?
...
[specularExponent](fespotlightelement/specularexponent) →
[AnimatedNumber](animatednumber-class)?
...
[x](fespotlightelement/x) → [AnimatedNumber](animatednumber-class)?

::: {.features}
read-only
:::

[y](fespotlightelement/y) → [AnimatedNumber](animatednumber-class)?

::: {.features}
read-only
:::

[z](fespotlightelement/z) → [AnimatedNumber](animatednumber-class)?
...
[supported](fespotlightelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FESpotLightElement-class.html>
:::
