...
FEComponentTransferElement class
================================
...
[FEComponentTransferElement](fecomponenttransferelement/fecomponenttransferelement)()

::: {.constructor-modifier .features}
factory
:::

[FEComponentTransferElement.created](fecomponenttransferelement/fecomponenttransferelement.created)()
...
[height](fecomponenttransferelement/height) →
...
[in1](fecomponenttransferelement/in1) →
...
[result](fecomponenttransferelement/result) →
[AnimatedString](animatedstring-class)?
...
[width](fecomponenttransferelement/width) →
[AnimatedLength](animatedlength-class)?
...
[x](fecomponenttransferelement/x) →
[AnimatedLength](animatedlength-class)?
...
[y](fecomponenttransferelement/y) →
[AnimatedLength](animatedlength-class)?
...
[supported](fecomponenttransferelement/supported) →
[bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEComponentTransferElement-class.html>
:::
