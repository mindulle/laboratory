...
[FEFloodElement](fefloodelement/fefloodelement)()

::: {.constructor-modifier .features}
factory
:::

[FEFloodElement.created](fefloodelement/fefloodelement.created)()
...
[width](fefloodelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[x](fefloodelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](fefloodelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](fefloodelement/supported) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEFloodElement-class.html>
:::
