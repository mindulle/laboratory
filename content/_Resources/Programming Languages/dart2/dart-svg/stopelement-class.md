...
[StopElement](stopelement/stopelement)()

::: {.constructor-modifier .features}
factory
:::

[StopElement.created](stopelement/stopelement.created)()
...
[gradientOffset](stopelement/gradientoffset) →
[AnimatedNumber](animatednumber-class)

::: {.features}
\@JSName(\'offset\'), read-only
:::
...
<https://api.dart.dev/stable/2.18.5/dart-svg/StopElement-class.html>
:::
