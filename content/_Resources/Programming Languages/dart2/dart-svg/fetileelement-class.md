...
[FETileElement](fetileelement/fetileelement)()

::: {.constructor-modifier .features}
factory
:::

[FETileElement.created](fetileelement/fetileelement.created)()
...
[height](fetileelement/height) → [AnimatedLength](animatedlength-class)?
...
[in1](fetileelement/in1) → [AnimatedString](animatedstring-class)?
...
[result](fetileelement/result) → [AnimatedString](animatedstring-class)?
...
[width](fetileelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[x](fetileelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](fetileelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](fetileelement/supported) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FETileElement-class.html>
:::
