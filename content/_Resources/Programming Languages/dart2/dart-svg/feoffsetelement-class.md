...
[FEOffsetElement](feoffsetelement/feoffsetelement)()

::: {.constructor-modifier .features}
factory
:::

[FEOffsetElement.created](feoffsetelement/feoffsetelement.created)()
...
[dx](feoffsetelement/dx) → [AnimatedNumber](animatednumber-class)?

::: {.features}
read-only
:::

[dy](feoffsetelement/dy) → [AnimatedNumber](animatednumber-class)?
...
[in1](feoffsetelement/in1) → [AnimatedString](animatedstring-class)?
...
[width](feoffsetelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[x](feoffsetelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](feoffsetelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](feoffsetelement/supported) → [bool](../dart-core/bool-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEOffsetElement-class.html>
:::
