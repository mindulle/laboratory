...
[TextContentElement.created](textcontentelement/textcontentelement.created)()
...
[LENGTHADJUST\_SPACING](textcontentelement/lengthadjust_spacing-constant) → const [int](../dart-core/int-class)
...
[LENGTHADJUST\_SPACINGANDGLYPHS](textcontentelement/lengthadjust_spacingandglyphs-constant) → const [int](../dart-core/int-class)
...
[LENGTHADJUST\_UNKNOWN](textcontentelement/lengthadjust_unknown-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/TextContentElement-class.html>
:::
