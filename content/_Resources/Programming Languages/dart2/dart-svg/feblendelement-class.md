...
[FEBlendElement](feblendelement/feblendelement)()

::: {.constructor-modifier .features}
factory
:::

[FEBlendElement.created](feblendelement/feblendelement.created)()
...
[in1](feblendelement/in1) → [AnimatedString](animatedstring-class)?

::: {.features}
read-only
:::

[in2](feblendelement/in2) → [AnimatedString](animatedstring-class)?
...
[width](feblendelement/width) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[x](feblendelement/x) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only, override
:::

[y](feblendelement/y) → [AnimatedLength](animatedlength-class)?
...
[supported](feblendelement/supported) → [bool](../dart-core/bool-class)
...
[SVG\_FEBLEND\_MODE\_DARKEN](feblendelement/svg_feblend_mode_darken-constant) → const [int](../dart-core/int-class)
...
[SVG\_FEBLEND\_MODE\_LIGHTEN](feblendelement/svg_feblend_mode_lighten-constant) → const [int](../dart-core/int-class)
...
[SVG\_FEBLEND\_MODE\_MULTIPLY](feblendelement/svg_feblend_mode_multiply-constant) → const [int](../dart-core/int-class)
...
[SVG\_FEBLEND\_MODE\_NORMAL](feblendelement/svg_feblend_mode_normal-constant) → const [int](../dart-core/int-class)
...
[SVG\_FEBLEND\_MODE\_SCREEN](feblendelement/svg_feblend_mode_screen-constant) → const [int](../dart-core/int-class)
...
[SVG\_FEBLEND\_MODE\_UNKNOWN](feblendelement/svg_feblend_mode_unknown-constant) → const [int](../dart-core/int-class)
...
<https://api.dart.dev/stable/2.18.5/dart-svg/FEBlendElement-class.html>
:::
