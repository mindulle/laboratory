...
[LinearGradientElement](lineargradientelement/lineargradientelement)()

::: {.constructor-modifier .features}
factory
:::

[LinearGradientElement.created](lineargradientelement/lineargradientelement.created)()
...
[gradientTransform](lineargradientelement/gradienttransform) →
...
[gradientUnits](lineargradientelement/gradientunits) →
...
[href](lineargradientelement/href) →
...
[spreadMethod](lineargradientelement/spreadmethod) →
[AnimatedEnumeration](animatedenumeration-class)?
...
[x1](lineargradientelement/x1) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[x2](lineargradientelement/x2) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y1](lineargradientelement/y1) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[y2](lineargradientelement/y2) → [AnimatedLength](animatedlength-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/LinearGradientElement-class.html>
:::
