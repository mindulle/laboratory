...
[CircleElement.created](circleelement/circleelement.created)()
...
[cx](circleelement/cx) → [AnimatedLength](animatedlength-class)?

::: {.features}
read-only
:::

[cy](circleelement/cy) → [AnimatedLength](animatedlength-class)?
...
[r](circleelement/r) → [AnimatedLength](animatedlength-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-svg/CircleElement-class.html>
:::
