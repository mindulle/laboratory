...
[GainNode](gainnode/gainnode)([BaseAudioContext](baseaudiocontext-class)
...
[gain](gainnode/gain) → [AudioParam](audioparam-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-web_audio/GainNode-class.html>
:::
