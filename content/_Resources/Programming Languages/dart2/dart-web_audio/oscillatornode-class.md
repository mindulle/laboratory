...
[OscillatorNode](oscillatornode/oscillatornode)([BaseAudioContext](baseaudiocontext-class)
...
[detune](oscillatornode/detune) → [AudioParam](audioparam-class)?

::: {.features}
read-only
:::

[frequency](oscillatornode/frequency) → [AudioParam](audioparam-class)?
...
[type](oscillatornode/type) ↔ [String](../dart-core/string-class)?
...
[setPeriodicWave](oscillatornode/setperiodicwave)([PeriodicWave](periodicwave-class)
periodicWave) → void
...
<https://api.dart.dev/stable/2.18.5/dart-web_audio/OscillatorNode-class.html>
:::
