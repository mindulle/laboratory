...
[DynamicsCompressorNode](dynamicscompressornode/dynamicscompressornode)([BaseAudioContext](baseaudiocontext-class)
...
[attack](dynamicscompressornode/attack) →
...
[knee](dynamicscompressornode/knee) → [AudioParam](audioparam-class)?
...
[ratio](dynamicscompressornode/ratio) → [AudioParam](audioparam-class)?

::: {.features}
read-only
:::

[reduction](dynamicscompressornode/reduction) →
...
[release](dynamicscompressornode/release) →
[AudioParam](audioparam-class)?
...
[threshold](dynamicscompressornode/threshold) →
[AudioParam](audioparam-class)?
...
<https://api.dart.dev/stable/2.18.5/dart-web_audio/DynamicsCompressorNode-class.html>
:::
