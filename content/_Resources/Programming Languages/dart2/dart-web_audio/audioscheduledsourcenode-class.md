...
[endedEvent](audioscheduledsourcenode/endedevent-constant) → const [EventStreamProvider](../dart-html/eventstreamprovider-class)\<[Event](../dart-html/event-class)\>
...
<https://api.dart.dev/stable/2.18.5/dart-web_audio/AudioScheduledSourceNode-class.html>
:::
