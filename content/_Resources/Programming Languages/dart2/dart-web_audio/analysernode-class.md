...
[AnalyserNode](analysernode/analysernode)([BaseAudioContext](baseaudiocontext-class)
...
[fftSize](analysernode/fftsize) ↔ [int](../dart-core/int-class)?
...
[maxDecibels](analysernode/maxdecibels) ↔ [num](../dart-core/num-class)?

::: {.features}
read / write
:::

[minDecibels](analysernode/mindecibels) ↔ [num](../dart-core/num-class)?
...
[getByteFrequencyData](analysernode/getbytefrequencydata)([Uint8List](../dart-typed_data/uint8list-class)
array) → void

[getByteTimeDomainData](analysernode/getbytetimedomaindata)([Uint8List](../dart-typed_data/uint8list-class)
array) → void

[getFloatFrequencyData](analysernode/getfloatfrequencydata)([Float32List](../dart-typed_data/float32list-class)
array) → void

[getFloatTimeDomainData](analysernode/getfloattimedomaindata)([Float32List](../dart-typed_data/float32list-class)
array) → void
...
<https://api.dart.dev/stable/2.18.5/dart-web_audio/AnalyserNode-class.html>
:::
