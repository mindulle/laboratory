...
[BiquadFilterNode](biquadfilternode/biquadfilternode)([BaseAudioContext](baseaudiocontext-class)
...
[detune](biquadfilternode/detune) → [AudioParam](audioparam-class)?

::: {.features}
read-only
:::

[frequency](biquadfilternode/frequency) →
...
[gain](biquadfilternode/gain) → [AudioParam](audioparam-class)?
...
[Q](biquadfilternode/q) → [AudioParam](audioparam-class)?
...
[type](biquadfilternode/type) ↔ [String](../dart-core/string-class)?
...
[getFrequencyResponse](biquadfilternode/getfrequencyresponse)([Float32List](../dart-typed_data/float32list-class)
frequencyHz, [Float32List](../dart-typed_data/float32list-class)
magResponse, [Float32List](../dart-typed_data/float32list-class)
phaseResponse) → void
...
<https://api.dart.dev/stable/2.18.5/dart-web_audio/BiquadFilterNode-class.html>
:::
