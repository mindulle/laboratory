...
the width of the logical inline borders of an element, which maps to a
...
[`border-block-width`](border-block-width.md), which sets
[`border-block-start-width`](border-block-start-width.md), and
...
Specification
  ...
  [\#
  propdef-border-inline-width]](https://drafts.csswg.org/css-logical/#propdef-border-inline-width)
