...
[pseudo-element](pseudo-elements.md) represents the \"new\" view state of a
view transition --- a live representation of the new view, after the
transition.
...
to animate `::view-transition-new`. These are dynamically generated
...
Specification
  ...
  [\#
  ::view-transition-new]](https://drafts.csswg.org/css-view-transitions/#::view-transition-new)
