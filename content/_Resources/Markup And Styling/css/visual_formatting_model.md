...
Initially defined in CSS2, the `display` property is extended in the
...
**Inline anonymous boxes** are created when a string is split by an
...
In the absolute positioning model (which also includes fixed
