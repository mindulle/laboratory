...
-----------------
  ...
  [Computed value](computed_value.md)   the absolute length or `0` if [`border-left-style`](border-left-style.md) is `none` or `hidden`
...
- The other border-left-related CSS properties: [`border`](border.md),
