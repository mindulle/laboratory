...
the style of the logical inline end border of an element, which maps to
...
[`border-inline-start-style`](border-inline-start-style.md), which define
the other border styles of the element.
