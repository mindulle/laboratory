...
The `:past` [CSS](https://developer.mozilla.org/en-US/docs/Web/CSS)
...
before an element that matches [`:current`](:current). For example in a
...
Specification
  ...
  [Selectors Level 4\
  [\#
  the-past-pseudo]](https://drafts.csswg.org/selectors/#the-past-pseudo)
