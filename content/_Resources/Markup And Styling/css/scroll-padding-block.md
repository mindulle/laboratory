...
The `scroll-padding-block` [shorthand property](shorthand_properties.md)
...
|                                   | shorthand:\                       |
|                                   |                                   |
|                                   | -   [](scroll-padding-block-start.md): |
|                                   |     `auto`                        |
|                                   | -   [](scroll-padding-block-end.md): |
|                                   |     `auto`                        |
+-----------------------------------+-----------------------------------+
...
Specification
  ...
  [\#
  propdef-scroll-padding-block]](https://drafts.csswg.org/css-scroll-snap/#propdef-scroll-padding-block)
