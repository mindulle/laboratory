...
We then look at *order of appearance*. The second one, the last of the
...
Now the paragraph will be blue. The `!important` in the earliest
...
Declarations in [`@keyframes`](@keyframes.md) don\'t participate in the
